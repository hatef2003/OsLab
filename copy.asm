 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 60 07 00 00 	jmp    *0x760(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 58 07 00 00       	mov    $0x758,%edx
        while(*s != 0){
 ...
 5c1:	a1 60 0a 00 00       	mov    0xa60,%eax
{
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 60 0a 00 00    	mov    %edx,0xa60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 60 0a 00 00    	mov    0xa60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 60 0a 00 00    	mov    0xa60,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 60 0a 00 00    	mov    0xa60,%edx
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 60 0a 00 00 64 	movl   $0xa64,0xa60
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf 64 0a 00 00       	mov    $0xa64,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 64 0a 00 00 64 	movl   $0xa64,0xa64
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 732:	00 00 00 
    if(p->s.size >= nunits){
