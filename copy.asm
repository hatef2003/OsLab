...
int main(int argc, char *argv[])
{
  ...
  30:	50                   	push   %eax
  31:	50                   	push   %eax
  32:	68 f8 07 00 00       	push   $0x7f8
  37:	6a 01                	push   $0x1
  39:	e8 52 04 00 00       	call   490 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 08 08 00 00       	mov    $0x808,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 b8 0a 00 00       	mov    0xab8,%eax
 ...
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 7d6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 7e2:	00 00 00 
    if(p->s.size >= nunits){
