...
00003973 <get_process_lifetime>:
SYSCALL(get_process_lifetime)
    3973:	b8 18 00 00 00       	mov    $0x18,%eax
    3978:	cd 40                	int    $0x40
    397a:	c3                   	ret    

0000397b <get_uncle_count>:
...
0000398b <copy_file>:
SYSCALL(copy_file)
    398b:	b8 16 00 00 00       	mov    $0x16,%eax
    3990:	cd 40                	int    $0x40
    3992:	c3                   	ret    

00003993 <find_digital_root>:
...
000039a3 <change_queue>:
SYSCALL(change_queue)
    39a3:	b8 1d 00 00 00       	mov    $0x1d,%eax
    39a8:	cd 40                	int    $0x40
    39aa:	c3                   	ret    

000039ab <bjf_validation_process>:
SYSCALL(bjf_validation_process)
    39ab:	b8 1e 00 00 00       	mov    $0x1e,%eax
    39b0:	cd 40                	int    $0x40
    39b2:	c3                   	ret    

000039b3 <bjf_validation_system>:
SYSCALL(bjf_validation_system)
    39b3:	b8 1f 00 00 00       	mov    $0x1f,%eax
    39b8:	cd 40                	int    $0x40
    39ba:	c3                   	ret    

000039bb <print_info>:
SYSCALL(print_info)
    39bb:	b8 20 00 00 00       	mov    $0x20,%eax
    39c0:	cd 40                	int    $0x40
    39c2:	c3                   	ret    

000039c3 <open_sharedmem>:
SYSCALL(open_sharedmem)
    39c3:	b8 21 00 00 00       	mov    $0x21,%eax
    39c8:	cd 40                	int    $0x40
    39ca:	c3                   	ret    

000039cb <close_sharedmem>:
    39cb:	b8 22 00 00 00       	mov    $0x22,%eax
    39d0:	cd 40                	int    $0x40
    39d2:	c3                   	ret    
