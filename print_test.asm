...
int main(int argc, char *argv[])
{
  ...
  1e:	e8 50 03 00 00       	call   373 <get_pid>
  23:	52                   	push   %edx
  24:	52                   	push   %edx
  25:	6a 01                	push   $0x1
  27:	50                   	push   %eax
  28:	e8 66 03 00 00       	call   393 <change_queue>
        sleep(100);
  2d:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  34:	e8 1a 03 00 00       	call   353 <sleep>
  ...
  44:	6a 0a                	push   $0xa
  46:	e8 08 03 00 00       	call   353 <sleep>
        print_info();
  4b:	e8 5b 03 00 00       	call   3ab <print_info>
        wait();
  50:	e8 76 02 00 00       	call   2cb <wait>
  55:	83 c4 10             	add    $0x10,%esp
  58:	eb e2                	jmp    3c <main+0x3c>
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
