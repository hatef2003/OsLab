...
int main(int argc, char *argv[])
{
  ...
  18:	75 2c                	jne    46 <main+0x46>
    {
        sleep(10);
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 0a                	push   $0xa
  1f:	e8 3f 03 00 00       	call   363 <sleep>
        printf(1, "child life :%d\n", get_process_lifetime(get_pid()));
  24:	e8 5a 03 00 00       	call   383 <get_pid>
  29:	89 04 24             	mov    %eax,(%esp)
  2c:	e8 42 03 00 00       	call   373 <get_process_lifetime>
  ...
  49:	6a 32                	push   $0x32
  4b:	e8 13 03 00 00       	call   363 <sleep>
        printf(1, "parent life_time : %d",get_process_lifetime(get_pid()));
  50:	e8 2e 03 00 00       	call   383 <get_pid>
  55:	89 04 24             	mov    %eax,(%esp)
  58:	e8 16 03 00 00       	call   373 <get_process_lifetime>
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba ae 07 00 00       	mov    $0x7ae,%edx
        while(*s != 0){
 ...
 601:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 b8 0a 00 00    	mov    %edx,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 772:	00 00 00 
    if(p->s.size >= nunits){
