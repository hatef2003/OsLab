...
int main(int argc, char *argv[])
{
  ...
  1c:	75 2c                	jne    4a <main+0x4a>
    {
        sleep(10);
  1e:	83 ec 0c             	sub    $0xc,%esp
  21:	6a 0a                	push   $0xa
  23:	e8 4b 03 00 00       	call   373 <sleep>
        printf(1, "child life :%d\n", get_process_lifetime(get_pid()));
  28:	e8 66 03 00 00       	call   393 <get_pid>
  2d:	89 04 24             	mov    %eax,(%esp)
  30:	e8 4e 03 00 00       	call   383 <get_process_lifetime>
  35:	83 c4 0c             	add    $0xc,%esp
  38:	50                   	push   %eax
  39:	68 28 08 00 00       	push   $0x828
  3e:	6a 01                	push   $0x1
  40:	e8 7b 04 00 00       	call   4c0 <printf>
        exit();
  45:	e8 99 02 00 00       	call   2e3 <exit>
    }
    else
    {
        sleep(50);
  ...
  4d:	6a 32                	push   $0x32
  4f:	e8 1f 03 00 00       	call   373 <sleep>
        printf(1, "parent life_time : %d",get_process_lifetime(get_pid()));
  54:	e8 3a 03 00 00       	call   393 <get_pid>
  59:	89 04 24             	mov    %eax,(%esp)
  5c:	e8 22 03 00 00       	call   383 <get_process_lifetime>
  61:	83 c4 0c             	add    $0xc,%esp
  64:	50                   	push   %eax
  65:	68 38 08 00 00       	push   $0x838
  6a:	6a 01                	push   $0x1
  6c:	e8 4f 04 00 00       	call   4c0 <printf>
        exit();
  71:	e8 6d 02 00 00       	call   2e3 <exit>
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
...
000003eb <Aquire>:
SYSCALL(Aquire)
 3eb:	b8 24 00 00 00       	mov    $0x24,%eax
 3f0:	cd 40                	int    $0x40
 3f2:	c3                   	ret    

000003f3 <R>:
SYSCALL(R)
 3f3:	b8 25 00 00 00       	mov    $0x25,%eax
 3f8:	cd 40                	int    $0x40
 3fa:	c3                   	ret    

000003fb <C>:
SYSCALL(C)
 3fb:	b8 26 00 00 00       	mov    $0x26,%eax
 400:	cd 40                	int    $0x40
 402:	c3                   	ret    
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 569:	e8 95 fd ff ff       	call   303 <write>
        putc(fd, c);
      } else {
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 4e 08 00 00       	mov    $0x84e,%ebx
        while(*s != 0){
 ...
 66b:	57                   	push   %edi
 66c:	53                   	push   %ebx
 66d:	e8 91 fc ff ff       	call   303 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 00 0b 00 00       	mov    %eax,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 00 0b 00 00    	mov    0xb00,%edi
 ...
 78b:	e8 db fb ff ff       	call   36b <sbrk>
  if(p == (char*)-1)
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 00 0b 00 00       	mov    0xb00,%eax
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 04 0b 00 00       	mov    $0xb04,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 812:	00 00 00 
    if(p->s.size >= nunits){
