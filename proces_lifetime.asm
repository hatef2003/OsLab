...
int main(int argc, char *argv[])
{
  ...
  1c:	75 2f                	jne    4d <main+0x4d>
    {
        sleep(1000);
  1e:	83 ec 0c             	sub    $0xc,%esp
  21:	68 e8 03 00 00       	push   $0x3e8
  26:	e8 48 03 00 00       	call   373 <sleep>
        printf(1, "child life :%d\n", get_process_lifetime(get_pid()));
  2b:	e8 63 03 00 00       	call   393 <get_pid>
  30:	89 04 24             	mov    %eax,(%esp)
  33:	e8 4b 03 00 00       	call   383 <get_process_lifetime>
  ...
  43:	e8 28 04 00 00       	call   470 <printf>
        exit();
  48:	e8 96 02 00 00       	call   2e3 <exit>
    }
    else
    {
        sleep(500);
  4d:	83 ec 0c             	sub    $0xc,%esp
  50:	68 f4 01 00 00       	push   $0x1f4
  55:	e8 19 03 00 00       	call   373 <sleep>
        printf(1, "parent life_time : %d",get_process_lifetime(get_pid()));
  5a:	e8 34 03 00 00       	call   393 <get_pid>
  5f:	89 04 24             	mov    %eax,(%esp)
  62:	e8 1c 03 00 00       	call   383 <get_process_lifetime>
  67:	83 c4 0c             	add    $0xc,%esp
  6a:	50                   	push   %eax
  6b:	68 e8 07 00 00       	push   $0x7e8
  70:	6a 01                	push   $0x1
  72:	e8 f9 03 00 00       	call   470 <printf>
        exit();
...
free(void *ap)
{
 ...
 645:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 b0 0a 00 00       	mov    %eax,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 b0 0a 00 00       	mov    0xab0,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 ...
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	bf b4 0a 00 00       	mov    $0xab4,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 7b6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 7c2:	00 00 00 
    if(p->s.size >= nunits){
