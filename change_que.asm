...
free(void *ap)
{
 ...
 635:	a1 80 0a 00 00       	mov    0xa80,%eax
{
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 80 0a 00 00       	mov    0xa80,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 7b2:	00 00 00 
    if(p->s.size >= nunits){
