...
int main(int argc, char *argv[])
{
  ...
  2f:	53                   	push   %ebx
  30:	50                   	push   %eax
  31:	e8 3d 03 00 00       	call   373 <change_queue>
...
000003ab <Aquire>:
SYSCALL(Aquire)
 3ab:	b8 24 00 00 00       	mov    $0x24,%eax
 3b0:	cd 40                	int    $0x40
 3b2:	c3                   	ret    

000003b3 <R>:
SYSCALL(R)
 3b3:	b8 25 00 00 00       	mov    $0x25,%eax
 3b8:	cd 40                	int    $0x40
 3ba:	c3                   	ret    

000003bb <C>:
SYSCALL(C)
 3bb:	b8 26 00 00 00       	mov    $0x26,%eax
 3c0:	cd 40                	int    $0x40
 3c2:	c3                   	ret    
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 44e:	56                   	push   %esi
 44f:	57                   	push   %edi
 450:	e8 6e fe ff ff       	call   2c3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 529:	e8 95 fd ff ff       	call   2c3 <write>
        putc(fd, c);
      } else {
 ...
 62b:	57                   	push   %edi
 62c:	53                   	push   %ebx
 62d:	e8 91 fc ff ff       	call   2c3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 a0 0a 00 00       	mov    %eax,0xaa0
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
 ...
 74b:	e8 db fb ff ff       	call   32b <sbrk>
  if(p == (char*)-1)
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 a0 0a 00 00 a4 	movl   $0xaa4,0xaa0
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf a4 0a 00 00       	mov    $0xaa4,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 a4 0a 00 00 a4 	movl   $0xaa4,0xaa4
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 7d2:	00 00 00 
    if(p->s.size >= nunits){
