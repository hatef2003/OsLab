...
printf(int fd, const char *fmt, ...)
{
 ...
 499:	e8 25 fe ff ff       	call   2c3 <write>
 ...
 4f9:	e8 c5 fd ff ff       	call   2c3 <write>
        putc(fd, c);
      } else {
 ...
 581:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 584:	e8 3a fd ff ff       	call   2c3 <write>
        ap++;
 ...
 5fb:	57                   	push   %edi
 5fc:	53                   	push   %ebx
 5fd:	e8 c1 fc ff ff       	call   2c3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
 ...
 71b:	e8 0b fc ff ff       	call   32b <sbrk>
  if(p == (char*)-1)
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 ...
 77e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf 74 0a 00 00       	mov    $0xa74,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79b:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 7a2:	00 00 00 
    if(p->s.size >= nunits){
