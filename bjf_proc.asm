...
int main(int argc, char* argv[]){
  ...
  28:	6a 01                	push   $0x1
  2a:	e8 b1 04 00 00       	call   4e0 <printf>
        return 1;
    }
...
0000040b <Aquire>:
SYSCALL(Aquire)
 40b:	b8 24 00 00 00       	mov    $0x24,%eax
 410:	cd 40                	int    $0x40
 412:	c3                   	ret    

00000413 <R>:
SYSCALL(R)
 413:	b8 25 00 00 00       	mov    $0x25,%eax
 418:	cd 40                	int    $0x40
 41a:	c3                   	ret    

0000041b <C>:
SYSCALL(C)
 41b:	b8 26 00 00 00       	mov    $0x26,%eax
 420:	cd 40                	int    $0x40
 422:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 589:	e8 95 fd ff ff       	call   323 <write>
        putc(fd, c);
      } else {
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb 59 08 00 00       	mov    $0x859,%ebx
        while(*s != 0){
 ...
 68b:	57                   	push   %edi
 68c:	53                   	push   %ebx
 68d:	e8 91 fc ff ff       	call   323 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7ab:	e8 db fb ff ff       	call   38b <sbrk>
  if(p == (char*)-1)
