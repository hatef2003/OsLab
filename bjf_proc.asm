...
000003f3 <print_lopck_que>:
SYSCALL(print_lopck_que)
 3f3:	b8 21 00 00 00       	mov    $0x21,%eax
 3f8:	cd 40                	int    $0x40
 3fa:	c3                   	ret    

000003fb <plock_test>:
SYSCALL(plock_test)
 3fb:	b8 22 00 00 00       	mov    $0x22,%eax
 400:	cd 40                	int    $0x40
 402:	c3                   	ret    

00000403 <open_shm>:
 403:	b8 23 00 00 00       	mov    $0x23,%eax
 408:	cd 40                	int    $0x40
 40a:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 39 08 00 00       	mov    $0x839,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 08 0b 00 00       	mov    0xb08,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 08 0b 00 00       	mov    %eax,0xb08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 08 0b 00 00       	mov    0xb08,%eax
 ...
 7d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7d7:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 08 0b 00 00 0c 	movl   $0xb0c,0xb08
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 0c 0b 00 00       	mov    $0xb0c,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 812:	00 00 00 
    if(p->s.size >= nunits){
