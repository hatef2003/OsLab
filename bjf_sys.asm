 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 20 08 00 00 	movzbl 0x820(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 19 08 00 00       	mov    $0x819,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 e8 0a 00 00       	mov    0xae8,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 ...
 7ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 7d7:	0a 00 00 
    base.s.size = 0;
 7da:	bf ec 0a 00 00       	mov    $0xaec,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 7e6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 7f2:	00 00 00 
    if(p->s.size >= nunits){
