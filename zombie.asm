...
printf(int fd, const char *fmt, ...)
{
 ...
 489:	e8 25 fe ff ff       	call   2b3 <write>
 ...
 4e9:	e8 c5 fd ff ff       	call   2b3 <write>
        putc(fd, c);
      } else {
 ...
 571:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 574:	e8 3a fd ff ff       	call   2b3 <write>
        ap++;
 ...
 5eb:	57                   	push   %edi
 5ec:	53                   	push   %ebx
 5ed:	e8 c1 fc ff ff       	call   2b3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
 ...
 70b:	e8 0b fc ff ff       	call   31b <sbrk>
  if(p == (char*)-1)
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 58 0a 00 00       	mov    0xa58,%eax
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 ...
 76e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 58 0a 00 00 5c 	movl   $0xa5c,0xa58
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf 5c 0a 00 00       	mov    $0xa5c,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 792:	00 00 00 
    if(p->s.size >= nunits){
