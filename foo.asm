...
0000038b <Aquire>:
SYSCALL(Aquire)
 38b:	b8 24 00 00 00       	mov    $0x24,%eax
 390:	cd 40                	int    $0x40
 392:	c3                   	ret    

00000393 <R>:
SYSCALL(R)
 393:	b8 25 00 00 00       	mov    $0x25,%eax
 398:	cd 40                	int    $0x40
 39a:	c3                   	ret    

0000039b <C>:
SYSCALL(C)
 39b:	b8 26 00 00 00       	mov    $0x26,%eax
 3a0:	cd 40                	int    $0x40
 3a2:	c3                   	ret    
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 42e:	56                   	push   %esi
 42f:	57                   	push   %edi
 430:	e8 6e fe ff ff       	call   2a3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 509:	e8 95 fd ff ff       	call   2a3 <write>
        putc(fd, c);
      } else {
 ...
 591:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 594:	e8 0a fd ff ff       	call   2a3 <write>
        ap++;
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb c8 07 00 00       	mov    $0x7c8,%ebx
        while(*s != 0){
 ...
 60b:	57                   	push   %edi
 60c:	53                   	push   %ebx
 60d:	e8 91 fc ff ff       	call   2a3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 70 0a 00 00       	mov    0xa70,%eax
{
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
 ...
 72b:	e8 db fb ff ff       	call   30b <sbrk>
  if(p == (char*)-1)
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 70 0a 00 00       	mov    0xa70,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 ...
 78e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf 74 0a 00 00       	mov    $0xa74,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 7b2:	00 00 00 
    if(p->s.size >= nunits){
