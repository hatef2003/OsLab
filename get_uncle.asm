...
int main(int argc, char *argv[])
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    int f = fork();
  15:	e8 b1 02 00 00       	call   2cb <fork>
    int third = -1;
    third = third;
    int temp = -1;
    temp = temp;
  ...
  21:	6a 0a                	push   $0xa
  23:	e8 3b 03 00 00       	call   363 <sleep>
    exit();
  28:	e8 a6 02 00 00       	call   2d3 <exit>
        s = fork();
  2d:	e8 99 02 00 00       	call   2cb <fork>
        if (s != 0 && f != 0)
  32:	85 c0                	test   %eax,%eax
  34:	74 e8                	je     1e <main+0x1e>
            third = fork();
  36:	e8 90 02 00 00       	call   2cb <fork>
    if (third == 0 && f != 0 && s != 0)
  3b:	85 c0                	test   %eax,%eax
  3d:	75 df                	jne    1e <main+0x1e>
        int tc = fork();
  3f:	e8 87 02 00 00       	call   2cb <fork>
        if (tc != 0)
  44:	85 c0                	test   %eax,%eax
  46:	74 d6                	je     1e <main+0x1e>
            printf(1, "%d", get_uncle_count(temp));
  48:	83 ec 0c             	sub    $0xc,%esp
  4b:	50                   	push   %eax
  4c:	e8 2a 03 00 00       	call   37b <get_uncle_count>
  51:	83 c4 0c             	add    $0xc,%esp
  54:	50                   	push   %eax
  55:	68 18 08 00 00       	push   $0x818
  5a:	6a 01                	push   $0x1
  5c:	e8 4f 04 00 00       	call   4b0 <printf>
  61:	83 c4 10             	add    $0x10,%esp
  64:	eb b8                	jmp    1e <main+0x1e>
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
...
000003db <Aquire>:
SYSCALL(Aquire)
 3db:	b8 24 00 00 00       	mov    $0x24,%eax
 3e0:	cd 40                	int    $0x40
 3e2:	c3                   	ret    

000003e3 <R>:
SYSCALL(R)
 3e3:	b8 25 00 00 00       	mov    $0x25,%eax
 3e8:	cd 40                	int    $0x40
 3ea:	c3                   	ret    

000003eb <C>:
SYSCALL(C)
 3eb:	b8 26 00 00 00       	mov    $0x26,%eax
 3f0:	cd 40                	int    $0x40
 3f2:	c3                   	ret    
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 24 08 00 00 	movzbl 0x824(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 559:	e8 95 fd ff ff       	call   2f3 <write>
        putc(fd, c);
      } else {
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 1b 08 00 00       	mov    $0x81b,%ebx
        while(*s != 0){
 ...
 65b:	57                   	push   %edi
 65c:	53                   	push   %ebx
 65d:	e8 91 fc ff ff       	call   2f3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 cc 0a 00 00       	mov    %eax,0xacc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
 ...
 77b:	e8 db fb ff ff       	call   35b <sbrk>
  if(p == (char*)-1)
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 cc 0a 00 00       	mov    0xacc,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 7e7:	0a 00 00 
    base.s.size = 0;
 7ea:	bf d0 0a 00 00       	mov    $0xad0,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 7f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 802:	00 00 00 
    if(p->s.size >= nunits){
