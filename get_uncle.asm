...
free(void *ap)
{
 ...
 635:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 ...
 78e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 7c 0a 00 00 80 	movl   $0xa80,0xa7c
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf 80 0a 00 00       	mov    $0xa80,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 7b2:	00 00 00 
    if(p->s.size >= nunits){
