...
printf(int fd, const char *fmt, ...)
{
 ...
 4c9:	e8 25 fe ff ff       	call   2f3 <write>
 ...
 529:	e8 c5 fd ff ff       	call   2f3 <write>
        putc(fd, c);
      } else {
 ...
 5b1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5b4:	e8 3a fd ff ff       	call   2f3 <write>
        ap++;
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb eb 07 00 00       	mov    $0x7eb,%ebx
        while(*s != 0){
 ...
 62b:	57                   	push   %edi
 62c:	53                   	push   %ebx
 62d:	e8 c1 fc ff ff       	call   2f3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d 9c 0a 00 00    	mov    0xa9c,%edi
 ...
 74b:	e8 0b fc ff ff       	call   35b <sbrk>
  if(p == (char*)-1)
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 9c 0a 00 00       	mov    0xa9c,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 9c 0a 00 00 a0 	movl   $0xaa0,0xa9c
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf a0 0a 00 00       	mov    $0xaa0,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 7d2:	00 00 00 
    if(p->s.size >= nunits){
