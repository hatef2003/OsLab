 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 a4 07 00 00 	jmp    *0x7a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba 9b 07 00 00       	mov    $0x79b,%edx
        while(*s != 0){
 ...
 611:	a1 a4 0a 00 00       	mov    0xaa4,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d a4 0a 00 00    	mov    0xaa4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d a4 0a 00 00    	mov    0xaa4,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf a8 0a 00 00       	mov    $0xaa8,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 ac 0a 00 00 00 	movl   $0x0,0xaac
 782:	00 00 00 
    if(p->s.size >= nunits){
