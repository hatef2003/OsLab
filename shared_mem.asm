...
_shared_mem:     file format elf32-i386
...
int main(int argc, char* argv[]){
   ...
   e:	83 ec 10             	sub    $0x10,%esp
    char* frame_address = (char*)open_sharedmem(1);
  11:	6a 01                	push   $0x1
  13:	e8 6b 03 00 00       	call   383 <open_sharedmem>
    char* value = (char*) frame_address;
    *value = 0;
  ...
  24:	e8 27 04 00 00       	call   450 <printf>
    int id = fork();
  29:	e8 5d 02 00 00       	call   28b <fork>
    if(id == 0){
    ...
    exit();
  2e:	e8 60 02 00 00       	call   293 <exit>
  33:	66 90                	xchg   %ax,%ax
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 7f 07 00 00       	mov    $0x77f,%edx
        while(*s != 0){
 ...
 5f1:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 88 0a 00 00    	mov    %edx,0xa88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 88 0a 00 00    	mov    0xa88,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 88 0a 00 00    	mov    %edx,0xa88
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 88 0a 00 00 8c 	movl   $0xa8c,0xa88
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf 8c 0a 00 00       	mov    $0xa8c,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 762:	00 00 00 
    if(p->s.size >= nunits){
