...
8010021b:	e8 40 44 00 00       	call   80104660 <acquire>
  b->refcnt--;
...
801002a0:	e8 bb 43 00 00       	call   80104660 <acquire>
  while(n > 0){
...
801005ab:	e8 b0 40 00 00       	call   80104660 <acquire>
  for(i = 0; i < n; i++)
...
801007e8:	e8 73 3e 00 00       	call   80104660 <acquire>
...
80100893:	e8 c8 3d 00 00       	call   80104660 <acquire>
  while((c = getc()) >= 0){
...
80100cd3:	e8 48 3c 00 00       	call   80104920 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 34 3c 00 00       	call   80104920 <strlen>
...
80100da1:	e8 3a 3b 00 00       	call   801048e0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e41:	e8 1a 38 00 00       	call   80104660 <acquire>
...
80100eaf:	e8 ac 37 00 00       	call   80104660 <acquire>
  if(f->ref < 1)
...
80100f01:	e8 5a 37 00 00       	call   80104660 <acquire>
  if(f->ref < 1)
...
8010136a:	e8 f1 32 00 00       	call   80104660 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 24 32 00 00       	call   80104600 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 f6 31 00 00       	call   80104600 <release>
      return ip;
...
80101541:	e8 7a 32 00 00       	call   801047c0 <memmove>
  brelse(bp);
...
80101576:	e8 15 2f 00 00       	call   80104490 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 cc 2d 00 00       	call   80104360 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 ff 31 00 00       	call   801047c0 <memmove>
  brelse(bp);
...
8010168e:	e8 8d 30 00 00       	call   80104720 <memset>
      dip->type = type;
...
80101731:	e8 8a 30 00 00       	call   801047c0 <memmove>
  log_write(bp);
...
8010175f:	e8 fc 2e 00 00       	call   80104660 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 8c 2e 00 00       	call   80104600 <release>
}
...
801017a2:	e8 f9 2b 00 00       	call   801043a0 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 a3 2f 00 00       	call   801047c0 <memmove>
    brelse(bp);
...
80101873:	e8 c8 2b 00 00       	call   80104440 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 6c 2b 00 00       	jmp    80104400 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 db 2a 00 00       	call   801043a0 <acquiresleep>
...
801018da:	e8 21 2b 00 00       	call   80104400 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 75 2d 00 00       	call   80104660 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 fb 2c 00 00       	jmp    80104600 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 4b 2d 00 00       	call   80104660 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 dc 2c 00 00       	call   80104600 <release>
    if(r == 1){
...
80101a23:	e8 18 2a 00 00       	call   80104440 <holdingsleep>
...
80101a3a:	e8 c1 29 00 00       	call   80104400 <releasesleep>
  iput(ip);
...
80101b37:	e8 84 2c 00 00       	call   801047c0 <memmove>
    brelse(bp);
...
80101c33:	e8 88 2b 00 00       	call   801047c0 <memmove>
    log_write(bp);
...
80101cce:	e8 5d 2b 00 00       	call   80104830 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 fe 2a 00 00       	call   80104830 <strncmp>
      continue;
...
80101dba:	e8 a1 28 00 00       	call   80104660 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 31 28 00 00       	call   80104600 <release>
...
80101e8c:	e8 af 25 00 00       	call   80104440 <holdingsleep>
...
80101eae:	e8 4d 25 00 00       	call   80104400 <releasesleep>
  iput(ip);
...
80101edb:	e8 e0 28 00 00       	call   801047c0 <memmove>
    name[len] = 0;
...
80101f2b:	e8 10 25 00 00       	call   80104440 <holdingsleep>
...
80101f4a:	e8 b1 24 00 00       	call   80104400 <releasesleep>
  iput(ip);
...
80101f6d:	e8 ce 24 00 00       	call   80104440 <holdingsleep>
...
80101f90:	e8 ab 24 00 00       	call   80104440 <holdingsleep>
...
80101fa7:	e8 54 24 00 00       	call   80104400 <releasesleep>
}
...
8010203d:	e8 3e 28 00 00       	call   80104880 <strncpy>
...
801021d0:	e8 bb 22 00 00       	call   80104490 <initlock>
...
8010224e:	e8 0d 24 00 00       	call   80104660 <acquire>
...
801022cb:	e8 30 23 00 00       	call   80104600 <release>
...
801022ee:	e8 4d 21 00 00       	call   80104440 <holdingsleep>
...
80102328:	e8 33 23 00 00       	call   80104660 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 75 22 00 00       	jmp    80104600 <release>
...
801024f2:	e8 29 22 00 00       	call   80104720 <memset>
...
80102528:	e8 33 21 00 00       	call   80104660 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 b8 20 00 00       	jmp    80104600 <release>
    panic("kfree");
...
80102625:	e8 66 1e 00 00       	call   80104490 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 a8 1f 00 00       	call   80104660 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 1a 1f 00 00       	call   80104600 <release>
  return (char*)r;
...
80102af7:	e8 74 1c 00 00       	call   80104770 <memcmp>
...
80102c24:	e8 97 1b 00 00       	call   801047c0 <memmove>
...
80102cd4:	e8 b7 17 00 00       	call   80104490 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 f0 18 00 00       	call   80104660 <acquire>
...
80102dbc:	e8 3f 18 00 00       	call   80104600 <release>
      break;
    }
  }
}
...
80102dde:	e8 7d 18 00 00       	call   80104660 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 df 17 00 00       	call   80104600 <release>
}
...
80102e36:	e8 25 18 00 00       	call   80104660 <acquire>
    wakeup(&log);
...
80102e58:	e8 a3 17 00 00       	call   80104600 <release>
...
80102eb4:	e8 07 19 00 00       	call   801047c0 <memmove>
...
80102f14:	e8 e7 16 00 00       	call   80104600 <release>
...
80102f76:	e8 e5 16 00 00       	call   80104660 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 46 16 00 00       	jmp    80104600 <release>
...
801030d4:	e8 e7 16 00 00       	call   801047c0 <memmove>
...
801031c4:	e8 a7 15 00 00       	call   80104770 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 ec 14 00 00       	call   80104770 <memcmp>
...
801033c8:	e8 a3 13 00 00       	call   80104770 <memcmp>
...
801034a9:	e8 e2 0f 00 00       	call   80104490 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 1c 11 00 00       	call   80104660 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 77 10 00 00       	jmp    80104600 <release>
...
801035dd:	e8 7e 10 00 00       	call   80104660 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 8f 0f 00 00       	call   80104600 <release>
        return -1;
...
801036c2:	e8 39 0f 00 00       	call   80104600 <release>
  return n;
...
801036e6:	e8 75 0f 00 00       	call   80104660 <acquire>
...
8010377e:	e8 7d 0e 00 00       	call   80104600 <release>
  return i;
...
80103799:	e8 62 0e 00 00       	call   80104600 <release>
      return -1;
...
801037c1:	e8 9a 0e 00 00       	call   80104660 <acquire>
...
801037fc:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103802:	e8 f9 0d 00 00       	call   80104600 <release>
...
80103836:	e8 e5 0e 00 00       	call   80104720 <memset>
...
8010385a:	e8 a1 0d 00 00       	call   80104600 <release>
}
...
8010388b:	e8 70 0d 00 00       	call   80104600 <release>
...
801038e0:	e8 ab 0b 00 00       	call   80104490 <initlock>
}
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 94 0b 00 00       	call   80104510 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 d4 0b 00 00       	call   80104560 <popcli>
}
...
801039e6:	e8 35 0d 00 00       	call   80104720 <memset>
...
80103a45:	e8 96 0e 00 00       	call   801048e0 <safestrcpy>
  p->cwd = namei("/");
...
80103a73:	e8 88 0b 00 00       	call   80104600 <release>
}
...
80103aa5:	e8 b6 0b 00 00       	call   80104660 <acquire>
...
80103ac8:	e8 33 0b 00 00       	call   80104600 <release>
}
...
80103aee:	e8 6d 0b 00 00       	call   80104660 <acquire>
...
80103b28:	e8 d3 0a 00 00       	call   80104600 <release>
}
...
80103b45:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b48:	e8 c3 09 00 00       	call   80104510 <pushcli>
  c = mycpu();
80103b4d:	e8 9e fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b52:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b58:	e8 03 0a 00 00       	call   80104560 <popcli>
  sz = curproc->sz;
...
80103bc6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103bc9:	e8 42 09 00 00       	call   80104510 <pushcli>
  c = mycpu();
80103bce:	e8 1d fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103bd3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bd9:	e8 82 09 00 00       	call   80104560 <popcli>
  if ((np = allocproc()) == 0)
...
80103d1e:	e8 3d 09 00 00       	call   80104660 <acquire>
...
80103d4b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103d52:	e8 e4 0b 00 00       	call   8010493b <swtch>
      switchkvm();
...
80103d7c:	e8 7f 08 00 00       	call   80104600 <release>
    sti();
...
80103df3:	e8 43 0b 00 00       	call   8010493b <swtch>
  mycpu()->intena = intena;
...
80103eba:	e8 a1 07 00 00       	call   80104660 <acquire>
...
80103feb:	0f 85 95 00 00 00    	jne    80104086 <wait+0x106>
  pushcli();
80103ff1:	e8 1a 05 00 00       	call   80104510 <pushcli>
  c = mycpu();
80103ff6:	e8 f5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103ffb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104001:	e8 5a 05 00 00       	call   80104560 <popcli>
  if (p == 0)
...
80104075:	e8 86 05 00 00       	call   80104600 <release>
        return pid;
...
80104093:	e8 68 05 00 00       	call   80104600 <release>
      return -1;
...
801040bc:	e8 9f 05 00 00       	call   80104660 <acquire>
  pushcli();
801040c1:	e8 4a 04 00 00       	call   80104510 <pushcli>
  c = mycpu();
801040c6:	e8 25 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801040cb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040d1:	e8 8a 04 00 00       	call   80104560 <popcli>
...
801040e9:	e8 12 05 00 00       	call   80104600 <release>
}
...
8010410c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010410f:	e8 fc 03 00 00       	call   80104510 <pushcli>
  c = mycpu();
80104114:	e8 d7 f7 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104119:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010411f:	e8 3c 04 00 00       	call   80104560 <popcli>
  if (p == 0)
...
80104140:	e8 1b 05 00 00       	call   80104660 <acquire>
    release(lk);
80104145:	89 34 24             	mov    %esi,(%esp)
80104148:	e8 b3 04 00 00       	call   80104600 <release>
  p->chan = chan;
...
8010416a:	e8 91 04 00 00       	call   80104600 <release>
    acquire(lk);
...
8010417b:	5d                   	pop    %ebp
    acquire(lk);
8010417c:	e9 df 04 00 00       	jmp    80104660 <acquire>
...
801041cf:	e8 8c 04 00 00       	call   80104660 <acquire>
...
80104210:	c9                   	leave  
  release(&ptable.lock);
80104211:	e9 ea 03 00 00       	jmp    80104600 <release>
...
8010422f:	e8 2c 04 00 00       	call   80104660 <acquire>
...
8010426b:	e8 90 03 00 00       	call   80104600 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104288:	e8 73 03 00 00       	call   80104600 <release>
}
...
8010436a:	68 84 7c 10 80       	push   $0x80107c84
...
801043d3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801043d9:	e8 92 f5 ff ff       	call   80103970 <myproc>
...
801043ec:	5d                   	pop    %ebp
  release(&lk->lk);
801043ed:	e9 0e 02 00 00       	jmp    80104600 <release>
...
8010440f:	e8 4c 02 00 00       	call   80104660 <acquire>
  lk->locked = 0;
...
80104434:	5d                   	pop    %ebp
  release(&lk->lk);
80104435:	e9 c6 01 00 00       	jmp    80104600 <release>
...
80104452:	e8 09 02 00 00       	call   80104660 <acquire>
...
80104464:	e8 97 01 00 00       	call   80104600 <release>
  return r;
}
...
8010447b:	e8 f0 f4 ff ff       	call   80103970 <myproc>
...
80104519:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010451a:	e8 d1 f3 ff ff       	call   801038f0 <mycpu>
8010451f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104525:	85 c0                	test   %eax,%eax
80104527:	74 17                	je     80104540 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104529:	e8 c2 f3 ff ff       	call   801038f0 <mycpu>
8010452e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80104551:	eb d6                	jmp    80104529 <pushcli+0x19>
...
8010456b:	75 35                	jne    801045a2 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010456d:	e8 7e f3 ff ff       	call   801038f0 <mycpu>
...
801045a5:	68 8f 7c 10 80       	push   $0x80107c8f
801045aa:	e8 d1 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045af:	83 ec 0c             	sub    $0xc,%esp
801045b2:	68 a6 7c 10 80       	push   $0x80107ca6
...
801045d3:	75 0b                	jne    801045e0 <holding+0x20>
  popcli();
801045d5:	e8 86 ff ff ff       	call   80104560 <popcli>
}
...
801045df:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
801045e0:	8b 5e 08             	mov    0x8(%esi),%ebx
801045e3:	e8 08 f3 ff ff       	call   801038f0 <mycpu>
801045e8:	39 c3                	cmp    %eax,%ebx
801045ea:	0f 94 c3             	sete   %bl
  popcli();
801045ed:	e8 6e ff ff ff       	call   80104560 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801045f2:	0f b6 db             	movzbl %bl,%ebx
}
...
80104605:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104608:	e8 03 ff ff ff       	call   80104510 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010460d:	8b 03                	mov    (%ebx),%eax
8010460f:	85 c0                	test   %eax,%eax
80104611:	75 15                	jne    80104628 <release+0x28>
  popcli();
80104613:	e8 48 ff ff ff       	call   80104560 <popcli>
    panic("release");
80104618:	83 ec 0c             	sub    $0xc,%esp
8010461b:	68 ad 7c 10 80       	push   $0x80107cad
80104620:	e8 5b bd ff ff       	call   80100380 <panic>
80104625:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104628:	8b 73 08             	mov    0x8(%ebx),%esi
8010462b:	e8 c0 f2 ff ff       	call   801038f0 <mycpu>
80104630:	39 c6                	cmp    %eax,%esi
80104632:	75 df                	jne    80104613 <release+0x13>
  popcli();
80104634:	e8 27 ff ff ff       	call   80104560 <popcli>
  lk->pcs[0] = 0;
80104639:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104640:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104647:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010464c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
80104657:	5d                   	pop    %ebp
  popcli();
80104658:	e9 03 ff ff ff       	jmp    80104560 <popcli>
...
80104667:	e8 a4 fe ff ff       	call   80104510 <pushcli>
  if(holding(lk))
8010466c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010466f:	e8 9c fe ff ff       	call   80104510 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104674:	8b 03                	mov    (%ebx),%eax
80104676:	85 c0                	test   %eax,%eax
80104678:	75 7e                	jne    801046f8 <acquire+0x98>
  popcli();
8010467a:	e8 e1 fe ff ff       	call   80104560 <popcli>
  asm volatile("lock; xchgl %0, %1" :
8010467f:	b9 01 00 00 00       	mov    $0x1,%ecx
80104684:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
80104688:	8b 55 08             	mov    0x8(%ebp),%edx
8010468b:	89 c8                	mov    %ecx,%eax
8010468d:	f0 87 02             	lock xchg %eax,(%edx)
80104690:	85 c0                	test   %eax,%eax
80104692:	75 f4                	jne    80104688 <acquire+0x28>
  __sync_synchronize();
80104694:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104699:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010469c:	e8 4f f2 ff ff       	call   801038f0 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801046a1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
801046a4:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
801046a6:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
801046a9:	31 c0                	xor    %eax,%eax
...
801046bc:	77 1a                	ja     801046d8 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
801046be:	8b 5a 04             	mov    0x4(%edx),%ebx
801046c1:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
801046c5:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
801046c8:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
801046ca:	83 f8 0a             	cmp    $0xa,%eax
801046cd:	75 e1                	jne    801046b0 <acquire+0x50>
}
801046cf:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801046d2:	c9                   	leave  
801046d3:	c3                   	ret    
801046d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
801046d8:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
801046dc:	8d 51 34             	lea    0x34(%ecx),%edx
801046df:	90                   	nop
    pcs[i] = 0;
801046e0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801046e6:	83 c0 04             	add    $0x4,%eax
801046e9:	39 c2                	cmp    %eax,%edx
801046eb:	75 f3                	jne    801046e0 <acquire+0x80>
}
...
801046f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801046f8:	8b 5b 08             	mov    0x8(%ebx),%ebx
801046fb:	e8 f0 f1 ff ff       	call   801038f0 <mycpu>
80104700:	39 c3                	cmp    %eax,%ebx
80104702:	0f 85 72 ff ff ff    	jne    8010467a <acquire+0x1a>
  popcli();
80104708:	e8 53 fe ff ff       	call   80104560 <popcli>
    panic("acquire");
8010470d:	83 ec 0c             	sub    $0xc,%esp
80104710:	68 b5 7c 10 80       	push   $0x80107cb5
80104715:	e8 66 bc ff ff       	call   80100380 <panic>
...
80104840:	74 2e                	je     80104870 <strncmp+0x40>
80104842:	01 d6                	add    %edx,%esi
...
80104850:	38 d8                	cmp    %bl,%al
80104852:	75 14                	jne    80104868 <strncmp+0x38>
    n--, p++, q++;
80104854:	83 c2 01             	add    $0x1,%edx
80104857:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010485a:	39 f2                	cmp    %esi,%edx
8010485c:	74 12                	je     80104870 <strncmp+0x40>
8010485e:	0f b6 01             	movzbl (%ecx),%eax
80104861:	0f b6 1a             	movzbl (%edx),%ebx
80104864:	84 c0                	test   %al,%al
80104866:	75 e8                	jne    80104850 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104868:	29 d8                	sub    %ebx,%eax
}
8010486a:	5b                   	pop    %ebx
8010486b:	5e                   	pop    %esi
8010486c:	5d                   	pop    %ebp
...
80104889:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
8010488c:	89 f0                	mov    %esi,%eax
8010488e:	eb 15                	jmp    801048a5 <strncpy+0x25>
80104890:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104894:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104897:	83 c0 01             	add    $0x1,%eax
8010489a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
8010489e:	88 50 ff             	mov    %dl,-0x1(%eax)
801048a1:	84 d2                	test   %dl,%dl
801048a3:	74 09                	je     801048ae <strncpy+0x2e>
801048a5:	89 cb                	mov    %ecx,%ebx
801048a7:	83 e9 01             	sub    $0x1,%ecx
801048aa:	85 db                	test   %ebx,%ebx
801048ac:	7f e2                	jg     80104890 <strncpy+0x10>
    ;
  while(n-- > 0)
801048ae:	89 c2                	mov    %eax,%edx
801048b0:	85 c9                	test   %ecx,%ecx
801048b2:	7e 17                	jle    801048cb <strncpy+0x4b>
801048b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
801048b8:	83 c2 01             	add    $0x1,%edx
801048bb:	89 c1                	mov    %eax,%ecx
801048bd:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
801048c1:	29 d1                	sub    %edx,%ecx
801048c3:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
801048c7:	85 c9                	test   %ecx,%ecx
801048c9:	7f ed                	jg     801048b8 <strncpy+0x38>
  return os;
}
801048cb:	5b                   	pop    %ebx
...
80104957:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010495a:	e8 11 f0 ff ff       	call   80103970 <myproc>
...
80104a36:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104a39:	e8 32 ef ff ff       	call   80103970 <myproc>
80104a3e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a40:	e8 2b ef ff ff       	call   80103970 <myproc>
...
80104a4e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a51:	e8 1a ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a74:	76 1a                	jbe    80104a90 <argptr+0x60>
...
80104ab3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ab6:	e8 b5 ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104acb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104ace:	e8 9d ee ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104af5:	76 11                	jbe    80104b08 <argstr+0x68>
    if(*s == 0)
...
80104b24:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b27:	e8 44 ee ff ff       	call   80103970 <myproc>
...
80104b3c:	8b 14 85 e0 7c 10 80 	mov    -0x7fef8320(,%eax,4),%edx
...
80104b60:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104b61:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104b64:	50                   	push   %eax
80104b65:	ff 73 10             	push   0x10(%ebx)
80104b68:	68 bd 7c 10 80       	push   $0x80107cbd
80104b6d:	e8 2e bb ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
...
80104ba7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if ((dp = nameiparent(path, name)) == 0)
80104baa:	e8 11 d5 ff ff       	call   801020c0 <nameiparent>
...
80104bcc:	e8 0f d1 ff ff       	call   80101ce0 <dirlookup>
80104bd1:	83 c4 10             	add    $0x10,%esp
80104bd4:	89 c6                	mov    %eax,%esi
80104bd6:	85 c0                	test   %eax,%eax
80104bd8:	74 56                	je     80104c30 <create+0xa0>
  {
    iunlockput(dp);
80104bda:	83 ec 0c             	sub    $0xc,%esp
80104bdd:	53                   	push   %ebx
80104bde:	e8 2d ce ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104be3:	89 34 24             	mov    %esi,(%esp)
80104be6:	e8 95 cb ff ff       	call   80101780 <ilock>
    if (type == T_FILE && ip->type == T_FILE)
80104beb:	83 c4 10             	add    $0x10,%esp
80104bee:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104bf3:	75 1b                	jne    80104c10 <create+0x80>
80104bf5:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104bfa:	75 14                	jne    80104c10 <create+0x80>
...
80104c13:	56                   	push   %esi
    return 0;
80104c14:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104c16:	e8 f5 cd ff ff       	call   80101a10 <iunlockput>
    return 0;
80104c1b:	83 c4 10             	add    $0x10,%esp
}
80104c1e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104c21:	89 f0                	mov    %esi,%eax
80104c23:	5b                   	pop    %ebx
80104c24:	5e                   	pop    %esi
80104c25:	5f                   	pop    %edi
80104c26:	5d                   	pop    %ebp
...
80104c38:	ff 33                	push   (%ebx)
80104c3a:	e8 d1 c9 ff ff       	call   80101610 <ialloc>
80104c3f:	83 c4 10             	add    $0x10,%esp
80104c42:	89 c6                	mov    %eax,%esi
80104c44:	85 c0                	test   %eax,%eax
80104c46:	0f 84 cd 00 00 00    	je     80104d19 <create+0x189>
  ilock(ip);
...
80104cb0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++; // for ".."
80104cb3:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
80104cb8:	53                   	push   %ebx
80104cb9:	e8 12 ca ff ff       	call   801016d0 <iupdate>
    if (dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104cbe:	83 c4 0c             	add    $0xc,%esp
80104cc1:	ff 76 04             	push   0x4(%esi)
80104cc4:	68 70 7d 10 80       	push   $0x80107d70
80104cc9:	56                   	push   %esi
80104cca:	e8 11 d3 ff ff       	call   80101fe0 <dirlink>
80104ccf:	83 c4 10             	add    $0x10,%esp
80104cd2:	85 c0                	test   %eax,%eax
80104cd4:	78 18                	js     80104cee <create+0x15e>
80104cd6:	83 ec 04             	sub    $0x4,%esp
80104cd9:	ff 73 04             	push   0x4(%ebx)
80104cdc:	68 6f 7d 10 80       	push   $0x80107d6f
80104ce1:	56                   	push   %esi
80104ce2:	e8 f9 d2 ff ff       	call   80101fe0 <dirlink>
80104ce7:	83 c4 10             	add    $0x10,%esp
80104cea:	85 c0                	test   %eax,%eax
80104cec:	79 92                	jns    80104c80 <create+0xf0>
      panic("create dots");
80104cee:	83 ec 0c             	sub    $0xc,%esp
80104cf1:	68 63 7d 10 80       	push   $0x80107d63
80104cf6:	e8 85 b6 ff ff       	call   80100380 <panic>
80104cfb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104cff:	90                   	nop
}
80104d00:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80104d03:	31 f6                	xor    %esi,%esi
}
80104d05:	5b                   	pop    %ebx
80104d06:	89 f0                	mov    %esi,%eax
80104d08:	5e                   	pop    %esi
80104d09:	5f                   	pop    %edi
80104d0a:	5d                   	pop    %ebp
80104d0b:	c3                   	ret    
...
80104d0f:	68 72 7d 10 80       	push   $0x80107d72
80104d14:	e8 67 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d19:	83 ec 0c             	sub    $0xc,%esp
80104d1c:	68 54 7d 10 80       	push   $0x80107d54
80104d21:	e8 5a b6 ff ff       	call   80100380 <panic>
...
80104d34:	89 d6                	mov    %edx,%esi
80104d36:	53                   	push   %ebx
80104d37:	89 c3                	mov    %eax,%ebx
  if (argint(n, &fd) < 0)
...
80104d42:	e8 99 fc ff ff       	call   801049e0 <argint>
80104d47:	83 c4 10             	add    $0x10,%esp
80104d4a:	85 c0                	test   %eax,%eax
80104d4c:	78 4a                	js     80104d98 <argfd.constprop.0+0x68>
  if(fd < 0){
80104d4e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d51:	85 c0                	test   %eax,%eax
80104d53:	78 4a                	js     80104d9f <argfd.constprop.0+0x6f>
  if(fd >=NOFILE){
80104d55:	83 f8 0f             	cmp    $0xf,%eax
80104d58:	7f 26                	jg     80104d80 <argfd.constprop.0+0x50>
  if((f = myproc() -> ofile[fd]) == 0){
80104d5a:	e8 11 ec ff ff       	call   80103970 <myproc>
80104d5f:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d62:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
80104d66:	85 c0                	test   %eax,%eax
80104d68:	74 3c                	je     80104da6 <argfd.constprop.0+0x76>
  if (pfd)
80104d6a:	85 db                	test   %ebx,%ebx
80104d6c:	74 02                	je     80104d70 <argfd.constprop.0+0x40>
    *pfd = fd;
80104d6e:	89 13                	mov    %edx,(%ebx)
    *pf = f;
80104d70:	89 06                	mov    %eax,(%esi)
  return 0;
80104d72:	31 c0                	xor    %eax,%eax
}
...
80104d84:	68 14 7b 10 80       	push   $0x80107b14
80104d89:	e8 12 b9 ff ff       	call   801006a0 <cprintf>
    return -3;
80104d8e:	83 c4 10             	add    $0x10,%esp
80104d91:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
80104d96:	eb dc                	jmp    80104d74 <argfd.constprop.0+0x44>
    return -1;
80104d98:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d9d:	eb d5                	jmp    80104d74 <argfd.constprop.0+0x44>
    return -2;
80104d9f:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104da4:	eb ce                	jmp    80104d74 <argfd.constprop.0+0x44>
    return -4;
80104da6:	b8 fc ff ff ff       	mov    $0xfffffffc,%eax
80104dab:	eb c7                	jmp    80104d74 <argfd.constprop.0+0x44>
...
80104dba:	83 ec 10             	sub    $0x10,%esp
  if (argfd(0, 0, &f) < 0)
80104dbd:	e8 6e ff ff ff       	call   80104d30 <argfd.constprop.0>
...
80104dc9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104dcb:	e8 a0 eb ff ff       	call   80103970 <myproc>
    if (curproc->ofile[fd] == 0)
80104dd0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104df0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104df3:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104e1b:	e8 10 ff ff ff       	call   80104d30 <argfd.constprop.0>
...
80104e3f:	ff 75 f0             	push   -0x10(%ebp)
...
80104e54:	ff 75 f0             	push   -0x10(%ebp)
80104e57:	ff 75 f4             	push   -0xc(%ebp)
80104e5a:	ff 75 ec             	push   -0x14(%ebp)
...
80104e8b:	e8 a0 fe ff ff       	call   80104d30 <argfd.constprop.0>
...
80104e9d:	e8 3e fb ff ff       	call   801049e0 <argint>
...
80104eaf:	ff 75 f0             	push   -0x10(%ebp)
80104eb2:	50                   	push   %eax
80104eb3:	6a 01                	push   $0x1
80104eb5:	e8 76 fb ff ff       	call   80104a30 <argptr>
...
80104ec4:	ff 75 f0             	push   -0x10(%ebp)
80104ec7:	ff 75 f4             	push   -0xc(%ebp)
80104eca:	ff 75 ec             	push   -0x14(%ebp)
80104ecd:	e8 de c1 ff ff       	call   801010b0 <filewrite>
...
80104efc:	e8 2f fe ff ff       	call   80104d30 <argfd.constprop.0>
80104f01:	85 c0                	test   %eax,%eax
80104f03:	78 2b                	js     80104f30 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f05:	e8 66 ea ff ff       	call   80103970 <myproc>
80104f0a:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104f0d:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104f10:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104f17:	00 
  fileclose(f);
80104f18:	ff 75 f4             	push   -0xc(%ebp)
80104f1b:	e8 d0 bf ff ff       	call   80100ef0 <fileclose>
  return 0;
...
80104f4b:	e8 e0 fd ff ff       	call   80104d30 <argfd.constprop.0>
...
80104f5f:	e8 cc fa ff ff       	call   80104a30 <argptr>
...
80104f6e:	ff 75 f4             	push   -0xc(%ebp)
80104f71:	ff 75 f0             	push   -0x10(%ebp)
80104f74:	e8 57 c0 ff ff       	call   80100fd0 <filestat>
...
80104f9f:	e8 fc fa ff ff       	call   80104aa0 <argstr>
...
8010505b:	e8 50 c8 ff ff       	call   801018b0 <iput>
  end_op();
80105060:	e8 6b dd ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010509d:	e8 6e c9 ff ff       	call   80101a10 <iunlockput>
  end_op();
801050a2:	e8 29 dd ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010512d:	58                   	pop    %eax
8010512e:	5a                   	pop    %edx
8010512f:	68 70 7d 10 80       	push   $0x80107d70
...
80105148:	68 6f 7d 10 80       	push   $0x80107d6f
...
801051a2:	e8 79 f5 ff ff       	call   80104720 <memset>
  if (writei(dp, (char *)&de, off, sizeof(de)) != sizeof(de))
...
801051e7:	e8 24 c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
801051ec:	e8 df db ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105246:	e8 c5 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010524b:	e8 80 db ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010527e:	e9 73 ff ff ff       	jmp    801051f6 <sys_unlink+0x116>
    end_op();
80105283:	e8 48 db ff ff       	call   80102dd0 <end_op>
    return -1;
...
801052cf:	e8 cc f7 ff ff       	call   80104aa0 <argstr>
...
801052e8:	e8 f3 f6 ff ff       	call   801049e0 <argint>
...
801052f2:	78 79                	js     8010536d <sys_open+0xad>
  ...
  begin_op();
801052f4:	e8 67 da ff ff       	call   80102d60 <begin_op>
...
80105387:	e8 04 f8 ff ff       	call   80104b90 <create>
    if (ip == 0)
...
801053a8:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801053ab:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
80105414:	e8 87 f6 ff ff       	call   80104aa0 <argstr>
...
8010543f:	e8 cc c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105444:	e8 87 d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105474:	e8 27 f6 ff ff       	call   80104aa0 <argstr>
...
80105489:	e8 52 f5 ff ff       	call   801049e0 <argint>
  if ((argstr(0, &path)) < 0 ||
...
8010549e:	e8 3d f5 ff ff       	call   801049e0 <argint>
      argint(1, &major) < 0 ||
...
801054f5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054f8:	e8 73 e4 ff ff       	call   80103970 <myproc>
...
8010550d:	e8 8e f5 ff ff       	call   80104aa0 <argstr>
...
80105544:	e8 17 c3 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105549:	58                   	pop    %eax
8010554a:	ff 76 6c             	push   0x6c(%esi)
...
801055b5:	e8 e6 f4 ff ff       	call   80104aa0 <argstr>
...
801055d1:	e8 0a f4 ff ff       	call   801049e0 <argint>
...
801055f0:	e8 2b f1 ff ff       	call   80104720 <memset>
...
8010561a:	e8 31 f3 ff ff       	call   80104950 <fetchint>
...
80105638:	e8 53 f3 ff ff       	call   80104990 <fetchstr>
...
801056a1:	e8 8a f3 ff ff       	call   80104a30 <argptr>
...
801056b8:	e8 73 dd ff ff       	call   80103430 <pipealloc>
...
801056c7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056c9:	e8 a2 e2 ff ff       	call   80103970 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
801056ce:	66 90                	xchg   %ax,%ax
    if (curproc->ofile[fd] == 0)
801056d0:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
80105765:	8d 85 e0 fb ff ff    	lea    -0x420(%ebp),%eax
{
8010576b:	53                   	push   %ebx
8010576c:	81 ec 34 04 00 00    	sub    $0x434,%esp
  if (argstr(0, &src) < 0 || argstr(1, &dest) < 0)
80105772:	50                   	push   %eax
80105773:	6a 00                	push   $0x0
80105775:	e8 26 f3 ff ff       	call   80104aa0 <argstr>
8010577a:	83 c4 10             	add    $0x10,%esp
8010577d:	85 c0                	test   %eax,%eax
8010577f:	0f 88 88 00 00 00    	js     8010580d <sys_copy_file+0xad>
80105785:	83 ec 08             	sub    $0x8,%esp
80105788:	8d 85 e4 fb ff ff    	lea    -0x41c(%ebp),%eax
8010578e:	50                   	push   %eax
8010578f:	6a 01                	push   $0x1
80105791:	e8 0a f3 ff ff       	call   80104aa0 <argstr>
80105796:	83 c4 10             	add    $0x10,%esp
80105799:	85 c0                	test   %eax,%eax
8010579b:	78 70                	js     8010580d <sys_copy_file+0xad>
    return -1;

  begin_op();
8010579d:	e8 be d5 ff ff       	call   80102d60 <begin_op>
      return -1;
    }
  }
  else
...
801057a5:	ff b5 e0 fb ff ff    	push   -0x420(%ebp)
801057ab:	e8 f0 c8 ff ff       	call   801020a0 <namei>
801057b0:	83 c4 10             	add    $0x10,%esp
801057b3:	89 c6                	mov    %eax,%esi
801057b5:	85 c0                	test   %eax,%eax
801057b7:	0f 84 c3 01 00 00    	je     80105980 <sys_copy_file+0x220>
    {
      end_op();
      return -1;
    }
...
801057c1:	e8 ba bf ff ff       	call   80101780 <ilock>
  ...
  if ((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0)
801057c6:	e8 65 b6 ff ff       	call   80100e30 <filealloc>
801057cb:	83 c4 10             	add    $0x10,%esp
801057ce:	89 c7                	mov    %eax,%edi
801057d0:	85 c0                	test   %eax,%eax
801057d2:	74 28                	je     801057fc <sys_copy_file+0x9c>
  struct proc *curproc = myproc();
801057d4:	e8 97 e1 ff ff       	call   80103970 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
801057d9:	31 db                	xor    %ebx,%ebx
801057db:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801057df:	90                   	nop
    if (curproc->ofile[fd] == 0)
801057e0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
801057e4:	85 d2                	test   %edx,%edx
801057e6:	74 38                	je     80105820 <sys_copy_file+0xc0>
  for (fd = 0; fd < NOFILE; fd++)
801057e8:	83 c3 01             	add    $0x1,%ebx
801057eb:	83 fb 10             	cmp    $0x10,%ebx
801057ee:	75 f0                	jne    801057e0 <sys_copy_file+0x80>
  }
...
801057f4:	e8 f7 b6 ff ff       	call   80100ef0 <fileclose>
801057f9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip2);
801057fc:	83 ec 0c             	sub    $0xc,%esp
801057ff:	56                   	push   %esi
80105800:	e8 0b c2 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105805:	e8 c6 d5 ff ff       	call   80102dd0 <end_op>
    return -1;
8010580a:	83 c4 10             	add    $0x10,%esp
8010580d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105812:	e9 61 01 00 00       	jmp    80105978 <sys_copy_file+0x218>
80105817:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010581e:	66 90                	xchg   %ax,%ax
  iunlock(ip);
80105820:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105823:	8d 53 08             	lea    0x8(%ebx),%edx
80105826:	89 7c 90 0c          	mov    %edi,0xc(%eax,%edx,4)
  iunlock(ip);
8010582a:	56                   	push   %esi
      curproc->ofile[fd] = f;
8010582b:	89 95 d4 fb ff ff    	mov    %edx,-0x42c(%ebp)
  iunlock(ip);
80105831:	e8 2a c0 ff ff       	call   80101860 <iunlock>
  end_op();
80105836:	e8 95 d5 ff ff       	call   80102dd0 <end_op>
  f->ip = ip;
8010583b:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(O_RDONLY & O_WRONLY);
8010583e:	be 01 00 00 00       	mov    $0x1,%esi
  f->type = FD_INODE;
80105843:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->off = 0;
80105849:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(O_RDONLY & O_WRONLY);
80105850:	66 89 77 08          	mov    %si,0x8(%edi)
  cprintf("%d\n",fd);
80105854:	5f                   	pop    %edi
80105855:	58                   	pop    %eax
80105856:	53                   	push   %ebx
80105857:	68 14 7b 10 80       	push   $0x80107b14
8010585c:	e8 3f ae ff ff       	call   801006a0 <cprintf>
  if((f = myproc() -> ofile[fd]) == 0){
80105861:	e8 0a e1 ff ff       	call   80103970 <myproc>
80105866:	8b 95 d4 fb ff ff    	mov    -0x42c(%ebp),%edx
8010586c:	83 c4 10             	add    $0x10,%esp
8010586f:	8b 44 90 0c          	mov    0xc(%eax,%edx,4),%eax
80105873:	85 c0                	test   %eax,%eax
80105875:	74 96                	je     8010580d <sys_copy_file+0xad>
  int read_chars = fileread(f, p, 1024);
80105877:	83 ec 04             	sub    $0x4,%esp
8010587a:	8d 8d e8 fb ff ff    	lea    -0x418(%ebp),%ecx
80105880:	68 00 04 00 00       	push   $0x400
80105885:	51                   	push   %ecx
80105886:	50                   	push   %eax
80105887:	e8 94 b7 ff ff       	call   80101020 <fileread>
8010588c:	89 85 d4 fb ff ff    	mov    %eax,-0x42c(%ebp)
  begin_op();
80105892:	e8 c9 d4 ff ff       	call   80102d60 <begin_op>
    if ((ip2 = namei(dest)) == 0)
80105897:	5b                   	pop    %ebx
80105898:	ff b5 e4 fb ff ff    	push   -0x41c(%ebp)
8010589e:	e8 fd c7 ff ff       	call   801020a0 <namei>
801058a3:	83 c4 10             	add    $0x10,%esp
801058a6:	89 c6                	mov    %eax,%esi
801058a8:	85 c0                	test   %eax,%eax
801058aa:	0f 84 d0 00 00 00    	je     80105980 <sys_copy_file+0x220>
    ilock(ip2);
801058b0:	83 ec 0c             	sub    $0xc,%esp
801058b3:	50                   	push   %eax
801058b4:	e8 c7 be ff ff       	call   80101780 <ilock>
    if (ip2->type == T_DIR && dest != O_RDONLY)
801058b9:	83 c4 10             	add    $0x10,%esp
801058bc:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801058c1:	75 0e                	jne    801058d1 <sys_copy_file+0x171>
801058c3:	8b 8d e4 fb ff ff    	mov    -0x41c(%ebp),%ecx
801058c9:	85 c9                	test   %ecx,%ecx
801058cb:	0f 85 2b ff ff ff    	jne    801057fc <sys_copy_file+0x9c>
  if ((f2 = filealloc()) == 0 || (fd2 = fdalloc(f2)) < 0)
801058d1:	e8 5a b5 ff ff       	call   80100e30 <filealloc>
801058d6:	89 c7                	mov    %eax,%edi
801058d8:	85 c0                	test   %eax,%eax
801058da:	0f 84 1c ff ff ff    	je     801057fc <sys_copy_file+0x9c>
  struct proc *curproc = myproc();
801058e0:	e8 8b e0 ff ff       	call   80103970 <myproc>
  for (fd = 0; fd < NOFILE; fd++)
801058e5:	31 db                	xor    %ebx,%ebx
    if (curproc->ofile[fd] == 0)
801058e7:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
801058eb:	85 d2                	test   %edx,%edx
801058ed:	74 15                	je     80105904 <sys_copy_file+0x1a4>
801058ef:	90                   	nop
  for (fd = 0; fd < NOFILE; fd++)
801058f0:	83 c3 01             	add    $0x1,%ebx
801058f3:	83 fb 10             	cmp    $0x10,%ebx
801058f6:	0f 84 f4 fe ff ff    	je     801057f0 <sys_copy_file+0x90>
    if (curproc->ofile[fd] == 0)
801058fc:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80105900:	85 d2                	test   %edx,%edx
80105902:	75 ec                	jne    801058f0 <sys_copy_file+0x190>
  }
  iunlock(ip2);
80105904:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105907:	8d 4b 08             	lea    0x8(%ebx),%ecx
8010590a:	89 7c 88 0c          	mov    %edi,0xc(%eax,%ecx,4)
  iunlock(ip2);
8010590e:	56                   	push   %esi
      curproc->ofile[fd] = f;
8010590f:	89 8d d0 fb ff ff    	mov    %ecx,-0x430(%ebp)
  iunlock(ip2);
80105915:	e8 46 bf ff ff       	call   80101860 <iunlock>
  end_op();
8010591a:	e8 b1 d4 ff ff       	call   80102dd0 <end_op>

  f2->type = FD_INODE;
  f2->ip = ip2;
  f2->off = 0;
  f2->readable = !(O_WRONLY & O_WRONLY);
8010591f:	b8 00 01 00 00       	mov    $0x100,%eax
  f2->ip = ip2;
80105924:	89 77 10             	mov    %esi,0x10(%edi)
  f2->readable = !(O_WRONLY & O_WRONLY);
80105927:	66 89 47 08          	mov    %ax,0x8(%edi)
  f2->type = FD_INODE;
8010592b:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f2->off = 0;
80105931:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  cprintf("%d\n",fd);
80105938:	5a                   	pop    %edx
80105939:	59                   	pop    %ecx
8010593a:	53                   	push   %ebx
8010593b:	68 14 7b 10 80       	push   $0x80107b14
80105940:	e8 5b ad ff ff       	call   801006a0 <cprintf>
  if((f = myproc() -> ofile[fd]) == 0){
80105945:	e8 26 e0 ff ff       	call   80103970 <myproc>
8010594a:	8b 8d d0 fb ff ff    	mov    -0x430(%ebp),%ecx
80105950:	83 c4 10             	add    $0x10,%esp
80105953:	8b 44 88 0c          	mov    0xc(%eax,%ecx,4),%eax
80105957:	85 c0                	test   %eax,%eax
80105959:	0f 84 ae fe ff ff    	je     8010580d <sys_copy_file+0xad>
...
80105962:	8d 95 e8 fb ff ff    	lea    -0x418(%ebp),%edx
80105968:	ff b5 d4 fb ff ff    	push   -0x42c(%ebp)
8010596e:	52                   	push   %edx
8010596f:	50                   	push   %eax
80105970:	e8 3b b7 ff ff       	call   801010b0 <filewrite>
  return written_chars;
80105975:	83 c4 10             	add    $0x10,%esp
}
80105978:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010597b:	5b                   	pop    %ebx
8010597c:	5e                   	pop    %esi
8010597d:	5f                   	pop    %edi
8010597e:	5d                   	pop    %ebp
8010597f:	c3                   	ret    
      end_op();
80105980:	e8 4b d4 ff ff       	call   80102dd0 <end_op>
      return -1;
80105985:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010598a:	eb ec                	jmp    80105978 <sys_copy_file+0x218>
...
{
  return fork();
80105990:	e9 2b e2 ff ff       	jmp    80103bc0 <fork>
...
801059a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801059a6:	e8 a5 e4 ff ff       	call   80103e50 <exit>
...
{
  return wait();
801059b0:	e9 cb e5 ff ff       	jmp    80103f80 <wait>
...
801059de:	e8 3d e8 ff ff       	call   80104220 <kill>
...
80105a1d:	e8 be ef ff ff       	call   801049e0 <argint>
...
80105a36:	e8 05 e1 ff ff       	call   80103b40 <growproc>
...
80105a6d:	e8 6e ef ff ff       	call   801049e0 <argint>
...
80105a80:	68 80 4d 11 80       	push   $0x80114d80
80105a85:	e8 d6 eb ff ff       	call   80104660 <acquire>
  ticks0 = ticks;
  while (ticks - ticks0 < n)
80105a8a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105a8d:	8b 1d 60 4d 11 80    	mov    0x80114d60,%ebx
  while (ticks - ticks0 < n)
...
80105aa3:	68 80 4d 11 80       	push   $0x80114d80
80105aa8:	68 60 4d 11 80       	push   $0x80114d60
80105aad:	e8 4e e6 ff ff       	call   80104100 <sleep>
  while (ticks - ticks0 < n)
80105ab2:	a1 60 4d 11 80       	mov    0x80114d60,%eax
...
80105ad5:	e8 26 eb ff ff       	call   80104600 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105af8:	e8 03 eb ff ff       	call   80104600 <release>
  return 0;
...
80105b14:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b17:	68 80 4d 11 80       	push   $0x80114d80
80105b1c:	e8 3f eb ff ff       	call   80104660 <acquire>
  xticks = ticks;
80105b21:	8b 1d 60 4d 11 80    	mov    0x80114d60,%ebx
  release(&tickslock);
80105b27:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
80105b2e:	e8 cd ea ff ff       	call   80104600 <release>
  return xticks;
}
...
80105b45:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while(num>=10)
80105b48:	83 fb 09             	cmp    $0x9,%ebx
80105b4b:	7e 2e                	jle    80105b7b <find_digital_root+0x3b>
  {
    int temp  = num;
    int res= 0 ;
    while(temp!=0)
...
80105b4d:	be cd cc cc cc       	mov    $0xcccccccd,%esi
80105b52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
80105b58:	89 d9                	mov    %ebx,%ecx
    int res= 0 ;
80105b5a:	31 db                	xor    %ebx,%ebx
80105b5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      int current_dig=temp%10;
80105b60:	89 c8                	mov    %ecx,%eax
80105b62:	f7 e6                	mul    %esi
80105b64:	c1 ea 03             	shr    $0x3,%edx
80105b67:	8d 04 92             	lea    (%edx,%edx,4),%eax
80105b6a:	01 c0                	add    %eax,%eax
80105b6c:	29 c1                	sub    %eax,%ecx
      res+=current_dig;
80105b6e:	01 cb                	add    %ecx,%ebx
      temp/=10;
80105b70:	89 d1                	mov    %edx,%ecx
    while(temp!=0)
80105b72:	85 d2                	test   %edx,%edx
80105b74:	75 ea                	jne    80105b60 <find_digital_root+0x20>
  while(num>=10)
80105b76:	83 fb 09             	cmp    $0x9,%ebx
80105b79:	7f dd                	jg     80105b58 <find_digital_root+0x18>
    }
    num=res;
  }
  return num;
}
80105b7b:	89 d8                	mov    %ebx,%eax
80105b7d:	5b                   	pop    %ebx
80105b7e:	5e                   	pop    %esi
80105b7f:	5d                   	pop    %ebp
80105b80:	c3                   	ret    
...
80105b9a:	8b 40 18             	mov    0x18(%eax),%eax
80105b9d:	8b 58 10             	mov    0x10(%eax),%ebx
  while(num>=10)
80105ba0:	83 fb 09             	cmp    $0x9,%ebx
80105ba3:	7e 2e                	jle    80105bd3 <sys_find_digital_root+0x43>
      int current_dig=temp%10;
80105ba5:	be cd cc cc cc       	mov    $0xcccccccd,%esi
80105baa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
80105bb0:	89 d9                	mov    %ebx,%ecx
    int res= 0 ;
80105bb2:	31 db                	xor    %ebx,%ebx
80105bb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      int current_dig=temp%10;
80105bb8:	89 c8                	mov    %ecx,%eax
80105bba:	f7 e6                	mul    %esi
80105bbc:	c1 ea 03             	shr    $0x3,%edx
80105bbf:	8d 04 92             	lea    (%edx,%edx,4),%eax
80105bc2:	01 c0                	add    %eax,%eax
80105bc4:	29 c1                	sub    %eax,%ecx
      res+=current_dig;
80105bc6:	01 cb                	add    %ecx,%ebx
      temp/=10;
80105bc8:	89 d1                	mov    %edx,%ecx
    while(temp!=0)
80105bca:	85 d2                	test   %edx,%edx
80105bcc:	75 ea                	jne    80105bb8 <sys_find_digital_root+0x28>
  while(num>=10)
80105bce:	83 fb 09             	cmp    $0x9,%ebx
80105bd1:	7f dd                	jg     80105bb0 <sys_find_digital_root+0x20>
...
80105bec:	e8 ef ed ff ff       	call   801049e0 <argint>
80105bf1:	83 c4 10             	add    $0x10,%esp
80105bf4:	85 c0                	test   %eax,%eax
80105bf6:	78 28                	js     80105c20 <sys_get_uncle_count+0x40>
  {
    return -1;
  }
  struct proc *grandFather = find_proc(pid)->parent->parent;
80105bf8:	83 ec 0c             	sub    $0xc,%esp
80105bfb:	ff 75 f4             	push   -0xc(%ebp)
80105bfe:	e8 8d de ff ff       	call   80103a90 <find_proc>
  return count_child(grandFather) - 1;
80105c03:	5a                   	pop    %edx
  struct proc *grandFather = find_proc(pid)->parent->parent;
80105c04:	8b 40 14             	mov    0x14(%eax),%eax
  return count_child(grandFather) - 1;
80105c07:	ff 70 14             	push   0x14(%eax)
80105c0a:	e8 d1 de ff ff       	call   80103ae0 <count_child>
80105c0f:	83 c4 10             	add    $0x10,%esp
}
80105c12:	c9                   	leave  
  return count_child(grandFather) - 1;
80105c13:	83 e8 01             	sub    $0x1,%eax
}
80105c16:	c3                   	ret    
...
80105c30 <sys_get_process_lifetime>:
...
80105c37:	8b 1d 60 4d 11 80    	mov    0x80114d60,%ebx
80105c3d:	e8 2e dd ff ff       	call   80103970 <myproc>
80105c42:	2b 58 20             	sub    0x20(%eax),%ebx
80105c45:	89 d8                	mov    %ebx,%eax
}
80105c47:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105c4a:	c9                   	leave  
80105c4b:	c3                   	ret    
...
80105c5e:	e8 cd ed ff ff       	call   80104a30 <argptr>
...
80105d54:	66 a3 c6 4f 11 80    	mov    %ax,0x80114fc6
  initlock(&tickslock, "time");
80105d5a:	e8 31 e7 ff ff       	call   80104490 <initlock>
}
...
80105f35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f38:	e8 e3 eb ff ff       	call   80104b20 <syscall>
    if(myproc()->killed)
...
80105fb5:	e8 a6 e6 ff ff       	call   80104660 <acquire>
      wakeup(&ticks);
...
80105fd4:	e8 27 e6 ff ff       	call   80104600 <release>
...
80106d75:	e8 a6 d9 ff ff       	call   80104720 <memset>
...
80106e94:	0f 84 c2 00 00 00    	je     80106f5c <switchuvm+0xec>
  pushcli();
80106e9a:	e8 71 d6 ff ff       	call   80104510 <pushcli>
...
80106f49:	5d                   	pop    %ebp
  popcli();
80106f4a:	e9 11 d6 ff ff       	jmp    80104560 <popcli>
...
80106faf:	e8 6c d7 ff ff       	call   80104720 <memset>
...
80106fe2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106fe3:	e9 d8 d7 ff ff       	jmp    801047c0 <memmove>
...
8010713b:	e8 e0 d5 ff ff       	call   80104720 <memset>
...
801072f0:	e8 2b d4 ff ff       	call   80104720 <memset>
...
80107460:	e8 5b d3 ff ff       	call   801047c0 <memmove>
...
80107590:	e8 2b d2 ff ff       	call   801047c0 <memmove>
    len -= n;
    buf += n;
