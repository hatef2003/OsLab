...
80102020:	68 7a 7b 10 80       	push   $0x80107b7a
...
80103b6f:	e8 cc 31 00 00       	call   80106d40 <switchuvm>
  return 0;
...
80103b8a:	e8 11 34 00 00       	call   80106fa0 <allocuvm>
...
80103baa:	e8 21 35 00 00       	call   801070d0 <deallocuvm>
...
80103bfc:	e8 4f 36 00 00       	call   80107250 <copyuvm>
...
80103d40:	e8 fb 2f 00 00       	call   80106d40 <switchuvm>
...
80103f6d:	68 e8 79 10 80       	push   $0x801079e8
80103f72:	e8 19 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f77:	83 ec 0c             	sub    $0xc,%esp
80103f7a:	68 db 79 10 80       	push   $0x801079db
...
80104089:	68 fa 79 10 80       	push   $0x801079fa
8010408e:	e8 fd c2 ff ff       	call   80100390 <panic>
    panic("sleep");
80104093:	83 ec 0c             	sub    $0xc,%esp
80104096:	68 f4 79 10 80       	push   $0x801079f4
...
8010413a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104141:	e8 ba 2f 00 00       	call   80107100 <freevm>
        release(&ptable.lock);
...
801042b3:	68 bf 7d 10 80       	push   $0x80107dbf
...
801042d4:	74 ea                	je     801042c0 <procdump+0x30>
      state = "???";
801042d6:	ba 0b 7a 10 80       	mov    $0x80107a0b,%edx
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042db:	83 f8 05             	cmp    $0x5,%eax
801042de:	77 11                	ja     801042f1 <procdump+0x61>
801042e0:	8b 14 85 6c 7a 10 80 	mov    -0x7fef8594(,%eax,4),%edx
      state = "???";
801042e7:	b8 0b 7a 10 80       	mov    $0x80107a0b,%eax
...
801042f6:	68 0f 7a 10 80       	push   $0x80107a0f
...
80104335:	68 61 74 10 80       	push   $0x80107461
...
8010436e:	68 84 7a 10 80       	push   $0x80107a84
...
801045b5:	68 8f 7a 10 80       	push   $0x80107a8f
801045ba:	e8 d1 bd ff ff       	call   80100390 <panic>
    panic("popcli");
801045bf:	83 ec 0c             	sub    $0xc,%esp
801045c2:	68 a6 7a 10 80       	push   $0x80107aa6
...
801046c7:	68 ad 7a 10 80       	push   $0x80107aad
...
80104720:	68 b5 7a 10 80       	push   $0x80107ab5
...
80104b1b:	83 fa 1b             	cmp    $0x1b,%edx
80104b1e:	77 20                	ja     80104b40 <syscall+0x40>
80104b20:	8b 14 85 e0 7a 10 80 	mov    -0x7fef8520(,%eax,4),%edx
...
80104b48:	68 bd 7a 10 80       	push   $0x80107abd
...
80104ca4:	68 70 7b 10 80       	push   $0x80107b70
...
80104cbc:	68 6f 7b 10 80       	push   $0x80107b6f
...
80104cd1:	68 63 7b 10 80       	push   $0x80107b63
...
80104cef:	68 72 7b 10 80       	push   $0x80107b72
80104cf4:	e8 97 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104cf9:	83 ec 0c             	sub    $0xc,%esp
80104cfc:	68 54 7b 10 80       	push   $0x80107b54
...
801050ed:	58                   	pop    %eax
801050ee:	5a                   	pop    %edx
801050ef:	68 70 7b 10 80       	push   $0x80107b70
...
80105108:	68 6f 7b 10 80       	push   $0x80107b6f
...
80105769:	8d 45 f0             	lea    -0x10(%ebp),%eax
{
8010576c:	83 ec 14             	sub    $0x14,%esp
  if (argptr(0, &src, 32) < 0 || argptr(1, &dest, 32) < 0)
8010576f:	6a 20                	push   $0x20
80105771:	50                   	push   %eax
80105772:	6a 00                	push   $0x0
80105774:	e8 e7 f2 ff ff       	call   80104a60 <argptr>
80105779:	83 c4 10             	add    $0x10,%esp
8010577c:	85 c0                	test   %eax,%eax
8010577e:	0f 88 7c 00 00 00    	js     80105800 <sys_copy_file+0xa0>
80105784:	83 ec 04             	sub    $0x4,%esp
80105787:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010578a:	6a 20                	push   $0x20
8010578c:	50                   	push   %eax
8010578d:	6a 01                	push   $0x1
8010578f:	e8 cc f2 ff ff       	call   80104a60 <argptr>
80105794:	83 c4 10             	add    $0x10,%esp
80105797:	85 c0                	test   %eax,%eax
80105799:	78 65                	js     80105800 <sys_copy_file+0xa0>
    return -1;
  struct file *f;
  struct inode *ip;

  begin_op();
8010579b:	e8 90 d5 ff ff       	call   80102d30 <begin_op>
...
801057af:	e8 bc f3 ff ff       	call   80104b70 <create>
  if (ip == 0)
...
801057bb:	74 3e                	je     801057fb <sys_copy_file+0x9b>
  {
    end_op();
    return -1;
  }
  ...
  if ((f = filealloc()) == 0)
801057bd:	e8 3e b6 ff ff       	call   80100e00 <filealloc>
801057c2:	89 c3                	mov    %eax,%ebx
801057c4:	85 c0                	test   %eax,%eax
801057c6:	74 3f                	je     80105807 <sys_copy_file+0xa7>
  {
    iunlockput(ip);
    end_op();
    return -1;
...
801057cc:	e8 6f c0 ff ff       	call   80101840 <iunlock>
  end_op();
801057d1:	e8 ca d5 ff ff       	call   80102da0 <end_op>

  f->type = FD_INODE;
  f->ip = ip;
801057d6:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
  f->readable = 1;
801057d9:	b8 01 01 00 00       	mov    $0x101,%eax
  f->writable = 1;

  return 0;
801057de:	83 c4 10             	add    $0x10,%esp
  f->type = FD_INODE;
801057e1:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->off = 0;
801057e7:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = 1;
801057ee:	66 89 43 08          	mov    %ax,0x8(%ebx)
  return 0;
801057f2:	31 c0                	xor    %eax,%eax
801057f4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801057f7:	5b                   	pop    %ebx
801057f8:	5e                   	pop    %esi
801057f9:	5d                   	pop    %ebp
801057fa:	c3                   	ret    
    end_op();
801057fb:	e8 a0 d5 ff ff       	call   80102da0 <end_op>
    return -1;
80105800:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105805:	eb ed                	jmp    801057f4 <sys_copy_file+0x94>
    iunlockput(ip);
80105807:	83 ec 0c             	sub    $0xc,%esp
8010580a:	56                   	push   %esi
8010580b:	e8 f0 c1 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105810:	e8 8b d5 ff ff       	call   80102da0 <end_op>
    return -1;
80105815:	83 c4 10             	add    $0x10,%esp
80105818:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010581d:	eb d5                	jmp    801057f4 <sys_copy_file+0x94>
8010581f:	90                   	nop
...
80105820:	f3 0f 1e fb          	endbr32 
  return fork();
80105824:	e9 97 e3 ff ff       	jmp    80103bc0 <fork>
...
80105837:	83 ec 08             	sub    $0x8,%esp
  exit();
8010583a:	e8 11 e6 ff ff       	call   80103e50 <exit>
...
80105850:	f3 0f 1e fb          	endbr32 
  return wait();
80105854:	e9 47 e8 ff ff       	jmp    801040a0 <wait>
...
80105870:	e8 9b f1 ff ff       	call   80104a10 <argint>
...
80105882:	e8 79 e9 ff ff       	call   80104200 <kill>
...
801058d1:	e8 3a f1 ff ff       	call   80104a10 <argint>
...
801058ea:	e8 51 e2 ff ff       	call   80103b40 <growproc>
...
80105921:	e8 ea f0 ff ff       	call   80104a10 <argint>
...
80105939:	e8 e2 ec ff ff       	call   80104620 <acquire>
  ticks0 = ticks;
...
8010595d:	e8 7e e6 ff ff       	call   80103fe0 <sleep>
  while (ticks - ticks0 < n)
...
80105976:	8b 40 28             	mov    0x28(%eax),%eax
...
80105985:	e8 56 ed ff ff       	call   801046e0 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059a8:	e8 33 ed ff ff       	call   801046e0 <release>
  return 0;
...
801059f9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while (num >= 10)
801059fc:	83 fb 09             	cmp    $0x9,%ebx
801059ff:	7e 32                	jle    80105a33 <find_digital_root+0x43>
  {
    int temp = num;
    int res = 0;
    while (temp != 0)
...
80105a01:	be cd cc cc cc       	mov    $0xcccccccd,%esi
80105a06:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105a0d:	8d 76 00             	lea    0x0(%esi),%esi
{
80105a10:	89 d9                	mov    %ebx,%ecx
    int res = 0;
80105a12:	31 db                	xor    %ebx,%ebx
80105a14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      int current_dig = temp % 10;
80105a18:	89 c8                	mov    %ecx,%eax
80105a1a:	f7 e6                	mul    %esi
80105a1c:	c1 ea 03             	shr    $0x3,%edx
80105a1f:	8d 04 92             	lea    (%edx,%edx,4),%eax
80105a22:	01 c0                	add    %eax,%eax
80105a24:	29 c1                	sub    %eax,%ecx
      res += current_dig;
80105a26:	01 cb                	add    %ecx,%ebx
      temp /= 10;
80105a28:	89 d1                	mov    %edx,%ecx
    while (temp != 0)
80105a2a:	85 d2                	test   %edx,%edx
80105a2c:	75 ea                	jne    80105a18 <find_digital_root+0x28>
  while (num >= 10)
80105a2e:	83 fb 09             	cmp    $0x9,%ebx
80105a31:	7f dd                	jg     80105a10 <find_digital_root+0x20>
    }
    num = res;
  }
  return num;
...
80105a40 <sys_find_digital_root>:
...
80105a4e:	8b 40 18             	mov    0x18(%eax),%eax
80105a51:	8b 58 10             	mov    0x10(%eax),%ebx
  while (num >= 10)
80105a54:	83 fb 09             	cmp    $0x9,%ebx
80105a57:	7e 2a                	jle    80105a83 <sys_find_digital_root+0x43>
      int current_dig = temp % 10;
80105a59:	be cd cc cc cc       	mov    $0xcccccccd,%esi
80105a5e:	66 90                	xchg   %ax,%ax
{
80105a60:	89 d9                	mov    %ebx,%ecx
    int res = 0;
80105a62:	31 db                	xor    %ebx,%ebx
80105a64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      int current_dig = temp % 10;
80105a68:	89 c8                	mov    %ecx,%eax
80105a6a:	f7 e6                	mul    %esi
80105a6c:	c1 ea 03             	shr    $0x3,%edx
80105a6f:	8d 04 92             	lea    (%edx,%edx,4),%eax
80105a72:	01 c0                	add    %eax,%eax
80105a74:	29 c1                	sub    %eax,%ecx
      res += current_dig;
80105a76:	01 cb                	add    %ecx,%ebx
      temp /= 10;
80105a78:	89 d1                	mov    %edx,%ecx
    while (temp != 0)
80105a7a:	85 d2                	test   %edx,%edx
80105a7c:	75 ea                	jne    80105a68 <sys_find_digital_root+0x28>
  while (num >= 10)
80105a7e:	83 fb 09             	cmp    $0x9,%ebx
80105a81:	7f dd                	jg     80105a60 <sys_find_digital_root+0x20>
...
80105aa0:	e8 6b ef ff ff       	call   80104a10 <argint>
80105aa5:	83 c4 10             	add    $0x10,%esp
80105aa8:	85 c0                	test   %eax,%eax
80105aaa:	78 24                	js     80105ad0 <sys_get_uncle_count+0x40>
  {
    return -1;
  }
...
80105ab2:	e8 d9 df ff ff       	call   80103a90 <find_proc>
  return count_child(grandFather) - 1;
80105ab7:	5a                   	pop    %edx
  struct proc *grandFather = find_proc(pid)->parent->parent;
80105ab8:	8b 40 14             	mov    0x14(%eax),%eax
  return count_child(grandFather) - 1;
80105abb:	ff 70 14             	pushl  0x14(%eax)
80105abe:	e8 1d e0 ff ff       	call   80103ae0 <count_child>
...
80105ae0 <sys_get_process_lifetime>:
...
80105af1:	e8 1a ef ff ff       	call   80104a10 <argint>
80105af6:	83 c4 10             	add    $0x10,%esp
80105af9:	85 c0                	test   %eax,%eax
80105afb:	78 23                	js     80105b20 <sys_get_process_lifetime+0x40>
  {
    return -1;
  }
...
80105b03:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
80105b09:	e8 82 df ff ff       	call   80103a90 <find_proc>
80105b0e:	83 c4 10             	add    $0x10,%esp
80105b11:	2b 58 20             	sub    0x20(%eax),%ebx
...
80105b25:	eb ef                	jmp    80105b16 <sys_get_process_lifetime+0x36>
80105b27:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105b2e:	66 90                	xchg   %ax,%ax

80105b30 <sys_set_date>:
...
80105b63:	68 b8 7b 10 80       	push   $0x80107bb8
...
80105b76:	e8 15 ce ff ff       	call   80102990 <cmostime>
}
80105b7b:	83 c4 10             	add    $0x10,%esp
80105b7e:	c9                   	leave  
80105b7f:	c3                   	ret    

80105b80 <sys_get_pid>:
80105b80:	f3 0f 1e fb          	endbr32 
80105b84:	e9 17 fd ff ff       	jmp    801058a0 <sys_getpid>
80105b89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105b90 <sys_get_parent>:
...
80105b9a:	e8 c1 dd ff ff       	call   80103960 <myproc>
80105b9f:	8b 40 14             	mov    0x14(%eax),%eax
...
80105c1e:	00 00 ef 
  initlock(&tickslock, "time");
80105c21:	68 df 7b 10 80       	push   $0x80107bdf
...
80105c34:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
80105c3a:	e8 61 e8 ff ff       	call   801044a0 <initlock>
}
...
80105ca4:	3e ff 24 85 88 7c 10 	notrack jmp *-0x7fef8378(,%eax,4)
80105cab:	80 
    lapiceoi();
    break;
...
80105cfa:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105cfd:	56                   	push   %esi
80105cfe:	ff 70 10             	pushl  0x10(%eax)
80105d01:	68 44 7c 10 80       	push   $0x80107c44
...
80105d13:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105d28:	8b 50 28             	mov    0x28(%eax),%edx
...
80105d66:	8b 40 28             	mov    0x28(%eax),%eax
...
80105e1c:	68 ec 7b 10 80       	push   $0x80107bec
...
80105e44:	0f 85 0e ff ff ff    	jne    80105d58 <trap+0xd8>
    yield();
80105e4a:	e8 41 e1 ff ff       	call   80103f90 <yield>
...
80105e5d:	8b 70 28             	mov    0x28(%eax),%esi
...
80105e69:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e6c:	e8 8f ec ff ff       	call   80104b00 <syscall>
    if(myproc()->killed)
80105e71:	e8 ea da ff ff       	call   80103960 <myproc>
80105e76:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105e87:	5d                   	pop    %ebp
      exit();
80105e88:	e9 c3 df ff ff       	jmp    80103e50 <exit>
80105e8d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105e90:	e8 bb df ff ff       	call   80103e50 <exit>
80105e95:	e9 a6 fe ff ff       	jmp    80105d40 <trap+0xc0>
80105e9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105ea0:	e8 ab df ff ff       	call   80103e50 <exit>
...
80105eb8:	68 10 7c 10 80       	push   $0x80107c10
80105ebd:	e8 ee a7 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105ec2:	83 c4 14             	add    $0x14,%esp
80105ec5:	68 e4 7b 10 80       	push   $0x80107be4
...
80105fc3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105fc8:	bb 08 7d 10 80       	mov    $0x80107d08,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106b2a:	e8 01 dc ff ff       	call   80104730 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106bcd:	68 10 7d 10 80       	push   $0x80107d10
...
80106d68:	0f 84 c2 00 00 00    	je     80106e30 <switchuvm+0xf0>
  pushcli();
80106d6e:	e8 ad d7 ff ff       	call   80104520 <pushcli>
...
80106e83:	e8 a8 d8 ff ff       	call   80104730 <memset>
...
80106eb6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106eb7:	e9 14 d9 ff ff       	jmp    801047d0 <memmove>
    panic("inituvm: more than a page");
80106ebc:	83 ec 0c             	sub    $0xc,%esp
80106ebf:	68 55 7d 10 80       	push   $0x80107d55
...
80106feb:	e8 40 d7 ff ff       	call   80104730 <memset>
...
80107029:	68 8d 7d 10 80       	push   $0x80107d8d
...
8010708b:	68 a5 7d 10 80       	push   $0x80107da5
...
8010716c:	68 c1 7d 10 80       	push   $0x80107dc1
...
801071a4:	e8 87 d5 ff ff       	call   80104730 <memset>
...
80107243:	68 d2 7d 10 80       	push   $0x80107dd2
...
80107290:	e8 3b d5 ff ff       	call   801047d0 <memmove>
...
80107329:	68 f6 7d 10 80       	push   $0x80107df6
8010732e:	e8 5d 90 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107333:	83 ec 0c             	sub    $0xc,%esp
80107336:	68 dc 7d 10 80       	push   $0x80107ddc
...
801073be:	e8 0d d4 ff ff       	call   801047d0 <memmove>
    len -= n;
    buf += n;
