...
_lock_test:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    int f = fork();
  15:	e8 a1 02 00 00       	call   2bb <fork>
    int s;
    int t;
    int e;
    if (f != 0)
  1a:	85 c0                	test   %eax,%eax
  1c:	75 0a                	jne    28 <main+0x28>
    }
    s = s;
    e = e;
    t = t;
//oljp
    plock_test();
  1e:	e8 98 03 00 00       	call   3bb <plock_test>
    exit();
  23:	e8 9b 02 00 00       	call   2c3 <exit>
        s = fork();
  28:	e8 8e 02 00 00       	call   2bb <fork>
        if (s != 0)
  2d:	85 c0                	test   %eax,%eax
  2f:	74 ed                	je     1e <main+0x1e>
            t = fork();
  31:	e8 85 02 00 00       	call   2bb <fork>
            if (t != 0)
  36:	85 c0                	test   %eax,%eax
  38:	74 e4                	je     1e <main+0x1e>
                e = fork();
  3a:	e8 7c 02 00 00       	call   2bb <fork>
                if (e != 0)
  3f:	85 c0                	test   %eax,%eax
  41:	74 db                	je     1e <main+0x1e>
                    sleep(100);
  43:	83 ec 0c             	sub    $0xc,%esp
  46:	6a 64                	push   $0x64
  48:	e8 06 03 00 00       	call   353 <sleep>
  4d:	83 c4 10             	add    $0x10,%esp
  50:	eb cc                	jmp    1e <main+0x1e>
  52:	66 90                	xchg   %ax,%ax
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb e8 07 00 00       	mov    $0x7e8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 98 0a 00 00       	mov    %eax,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 98 0a 00 00       	mov    0xa98,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf 9c 0a 00 00       	mov    $0xa9c,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 7d2:	00 00 00 
    if(p->s.size >= nunits){
