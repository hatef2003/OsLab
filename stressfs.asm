  ...
  1f:	31 db                	xor    %ebx,%ebx
{
  ...
  47:	73 66 73 
  printf(1, "stressfs starting\n");
  4a:	e8 31 05 00 00       	call   580 <printf>
  memset(data, 'a', sizeof(data));
  ...
  printf(1, "write %d\n", i);
  85:	68 fb 08 00 00       	push   $0x8fb
  8a:	6a 01                	push   $0x1
  8c:	e8 ef 04 00 00       	call   580 <printf>
  path[8] += i;
...
00000443 <get_process_lifetime>:
SYSCALL(get_process_lifetime)
 443:	b8 18 00 00 00       	mov    $0x18,%eax
 448:	cd 40                	int    $0x40
 44a:	c3                   	ret    

0000044b <get_uncle_count>:
...
0000047b <bjf_validation_process>:
SYSCALL(bjf_validation_process)
 47b:	b8 1e 00 00 00       	mov    $0x1e,%eax
 480:	cd 40                	int    $0x40
 482:	c3                   	ret    

00000483 <bjf_validation_system>:
...
00000493 <print_lopck_que>:
SYSCALL(print_lopck_que)
 493:	b8 21 00 00 00       	mov    $0x21,%eax
 498:	cd 40                	int    $0x40
 49a:	c3                   	ret    
...
000004a3 <open_shm>:
SYSCALL(open_shm)
 4a3:	b8 23 00 00 00       	mov    $0x23,%eax
 4a8:	cd 40                	int    $0x40
 4aa:	c3                   	ret    

000004ab <Aquire>:
SYSCALL(Aquire)
 4ab:	b8 24 00 00 00       	mov    $0x24,%eax
 4b0:	cd 40                	int    $0x40
 4b2:	c3                   	ret    

000004b3 <R>:
SYSCALL(R)
 4b3:	b8 25 00 00 00       	mov    $0x25,%eax
 4b8:	cd 40                	int    $0x40
 4ba:	c3                   	ret    

000004bb <C>:
SYSCALL(C)
 4bb:	b8 26 00 00 00       	mov    $0x26,%eax
 4c0:	cd 40                	int    $0x40
 4c2:	c3                   	ret    
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 509:	0f b6 92 14 09 00 00 	movzbl 0x914(%edx),%edx
 ...
 54e:	56                   	push   %esi
 54f:	57                   	push   %edi
 550:	e8 6e fe ff ff       	call   3c3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 629:	e8 95 fd ff ff       	call   3c3 <write>
        putc(fd, c);
      } else {
 ...
 6b1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6b4:	e8 0a fd ff ff       	call   3c3 <write>
        ap++;
 ...
 704:	eb 1a                	jmp    720 <printf+0x1a0>
          s = "(null)";
 706:	bb 0b 09 00 00       	mov    $0x90b,%ebx
        while(*s != 0){
 ...
 72b:	57                   	push   %edi
 72c:	53                   	push   %ebx
 72d:	e8 91 fc ff ff       	call   3c3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 755:	a1 cc 0b 00 00       	mov    0xbcc,%eax
{
 ...
 776:	73 10                	jae    788 <free+0x38>
{
 ...
 7a1:	5b                   	pop    %ebx
  freep = p;
 7a2:	a3 cc 0b 00 00       	mov    %eax,0xbcc
}
 7a7:	5e                   	pop    %esi
 7a8:	5f                   	pop    %edi
 7a9:	5d                   	pop    %ebp
 ...
 7c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7ca:	a3 cc 0b 00 00       	mov    %eax,0xbcc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7f0:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 839:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
 ...
 84b:	e8 db fb ff ff       	call   42b <sbrk>
  if(p == (char*)-1)
 ...
 862:	e8 e9 fe ff ff       	call   750 <free>
  return freep;
 867:	a1 cc 0b 00 00       	mov    0xbcc,%eax
 ...
 894:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 897:	a3 cc 0b 00 00       	mov    %eax,0xbcc
}
 ...
 8ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8b0:	c7 05 cc 0b 00 00 d0 	movl   $0xbd0,0xbcc
 8b7:	0b 00 00 
    base.s.size = 0;
 8ba:	bf d0 0b 00 00       	mov    $0xbd0,%edi
    base.s.ptr = freep = prevp = &base;
 8bf:	c7 05 d0 0b 00 00 d0 	movl   $0xbd0,0xbd0
 8c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8cb:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 8d2:	00 00 00 
    if(p->s.size >= nunits){
