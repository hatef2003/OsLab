...
main(int argc, char *argv[])
{
  ...
  57:	68 2f 08 00 00       	push   $0x82f
  5c:	50                   	push   %eax
  5d:	68 2a 08 00 00       	push   $0x82a
  62:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 31 08 00 00       	mov    $0x831,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 e8 0a 00 00       	mov    0xae8,%eax
