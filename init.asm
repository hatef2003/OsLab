...
main(void)
{
  ...
  91:	50                   	push   %eax
  92:	50                   	push   %eax
  93:	68 84 0b 00 00       	push   $0xb84
  98:	68 b8 08 00 00       	push   $0x8b8
  9d:	e8 d9 02 00 00       	call   37b <exec>
      printf(1, "init: exec sh failed\n");
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 bb 08 00 00       	push   $0x8bb
  a9:	6a 01                	push   $0x1
  ...
  b6:	6a 01                	push   $0x1
  b8:	6a 01                	push   $0x1
  ba:	68 88 08 00 00       	push   $0x888
  bf:	e8 c7 02 00 00       	call   38b <mknod>
    open("console", O_RDWR);
  c4:	58                   	pop    %eax
  c5:	5a                   	pop    %edx
  c6:	6a 02                	push   $0x2
  c8:	68 88 08 00 00       	push   $0x888
 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4a9:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb d1 08 00 00       	mov    $0x8d1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 8c 0b 00 00       	mov    %eax,0xb8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 8c 0b 00 00       	mov    0xb8c,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
 ...
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf 90 0b 00 00       	mov    $0xb90,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 90 0b 00 00 90 	movl   $0xb90,0xb90
 866:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 94 0b 00 00 00 	movl   $0x0,0xb94
 872:	00 00 00 
    if(p->s.size >= nunits){
