...
main(void)
{
  ...
  7d:	6a 01                	push   $0x1
  7f:	e8 3c 04 00 00       	call   4c0 <printf>
      exit();
  84:	e8 aa 02 00 00       	call   333 <exit>
      exec("sh", argv);
  89:	50                   	push   %eax
  8a:	50                   	push   %eax
  8b:	68 3c 0b 00 00       	push   $0xb3c
  90:	68 18 08 00 00       	push   $0x818
  95:	e8 d1 02 00 00       	call   36b <exec>
      printf(1, "init: exec sh failed\n");
  9a:	5a                   	pop    %edx
  9b:	59                   	pop    %ecx
  9c:	68 1b 08 00 00       	push   $0x81b
  a1:	6a 01                	push   $0x1
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 31 08 00 00       	mov    $0x831,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 44 0b 00 00    	mov    %edx,0xb44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 48 0b 00 00       	mov    $0xb48,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 7d2:	00 00 00 
    if(p->s.size >= nunits){
