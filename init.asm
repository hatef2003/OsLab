...
main(void)
{
  ...
  91:	50                   	push   %eax
  92:	50                   	push   %eax
  93:	68 34 0b 00 00       	push   $0xb34
  98:	68 68 08 00 00       	push   $0x868
  9d:	e8 d9 02 00 00       	call   37b <exec>
      printf(1, "init: exec sh failed\n");
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 6b 08 00 00       	push   $0x86b
  a9:	6a 01                	push   $0x1
  ab:	e8 20 04 00 00       	call   4d0 <printf>
      exit();
  ...
  b6:	6a 01                	push   $0x1
  b8:	6a 01                	push   $0x1
  ba:	68 38 08 00 00       	push   $0x838
  bf:	e8 c7 02 00 00       	call   38b <mknod>
    open("console", O_RDWR);
  c4:	58                   	pop    %eax
  c5:	5a                   	pop    %edx
  c6:	6a 02                	push   $0x2
  c8:	68 38 08 00 00       	push   $0x838
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 81 08 00 00       	mov    $0x881,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 3c 0b 00 00       	mov    %eax,0xb3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 3c 0b 00 00       	mov    0xb3c,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 ...
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 40 0b 00 00       	mov    $0xb40,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
