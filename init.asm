...
main(void)
{
  ...
  ab:	68 58 08 00 00       	push   $0x858
  b0:	e8 d6 02 00 00       	call   38b <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 5b 08 00 00       	push   $0x85b
  bc:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 7a 08 00 00       	mov    $0x87a,%ebx
        while(*s != 0){
